        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/form_bildirim_olustur',data,(response)=>{
...
$(document).on('click','.bildirim_olustur_satinalma',function (){
    ...
    $.post(baseurl + 'malzemetalepnew/yetkili_kontrol',data_update,(response)=>{
        let responses = jQuery.parseJSON(response);
        if(responses.status=='Success'){
            $('#loading-box').addClass('d-none');
            let talep_id = $('#talep_id').val();
...
$(document).on('click','#tehvil_print',function (){
    ...
    if (checked_count == 0) {
        ...
        $.post(baseurl + 'malzemetalepnew/tehvil_print',data,(response)=>{
            let responses = jQuery.parseJSON(response);
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/delete_item_form',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
...
$(document).on('click','.form_ban_products',function (){
    let item_id =$(this).attr('item_id');
    let durum =$(this).attr('durum');
    let type = $(this).attr('type_');
    let eq = $(this).attr('eq');
    $.confirm({
        ...
        content:'<form action="" class="formName">' +
            '<div class="form-group">' +
            '<p>Ürünü Listeden Kaldırmak Üzerisiniz?<p/>'+
            '</form>',
        buttons: {
            formSubmit: {
                text: 'Kaldır',
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/ban_item_form',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
                                ...
                                columnClass: "col-md-4 mx-auto",
                                title: 'Başarılı',
                                content: 'Başarılı Bir Şekilde iptal Edildi!',
                                buttons:{
                                    formSubmit: {
                                        text: 'Tamam',
                                        btnClass: 'btn-blue',
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/upload_file',data,(response) => {
                        let responses = jQuery.parseJSON(response);
                        $('#loading-box').addClass('d-none');
                        if(responses.status=='Success'){
                            $.alert({
...
$(document).on('click','.form_add_cari',function (){
    ...
    $.post(baseurl + 'malzemetalepnew/form_cari_list_create',data,(response)=>{
        let responses = jQuery.parseJSON(response);
        if(responses.status=='Success'){
            $('#loading-box').addClass('d-none');
            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/delete_cari_form',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/product_price_details_add',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/update_form',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/delete_file',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
...
$(document).on('click','.yonetim_users',function (){
    ...
    $.confirm({
        ...
        content: function () {
            ...
            let table_report='';
            $.post(baseurl + 'malzemetalepnew/get_all_users',data,(response) => {
...
$(document).on('click','#search_button_cari',function (){
    ...
    if(keyword.length < 3){
        ...
        $.post(baseurl + 'malzemetalepnew/search_cari',data,(response)=>{
            let responses = jQuery.parseJSON(response);
            if(responses.status=='Success'){
                $('#loading-box').addClass('d-none');
                $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalepnew/odeme_create',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                        ...
                        buttons: {
                            formSubmit: {
                                ...
                                action: function () {
                                    ...
                                    $.post(baseurl + 'malzemetalepnew/avans_create',data,(response)=>{
                                        let responses = jQuery.parseJSON(response);
                                        if(responses.status=='Success'){
                                            $('#loading-box').addClass('d-none');
                                            $.alert({
    ...
    if (checked_count == 0) {
        ...
        $('.one_tehvil_products:checked').each((index,item) => {
            ...
            product_details.push({
                product_id:$(item).attr('product_id'),
                teslimat_warehouse_id:$(item).attr('teslimat_warehouse_id'),
                warehouse_item_qty:$('.warehouse_item_qty').eq(eq).val(),
                warehouse_item_notes:$('.warehouse_item_notes').eq(eq).val(),
            })
        });
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalepnew/warehouse_talep_stock_update',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalepnew/siparis_senet_update',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalepnew/tehvil_senet_update',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                        ...
                        buttons: {
                            formSubmit: {
                                ...
                                action: function () {
                                    ...
                                    $.post(baseurl + 'malzemetalepnew/siparis_update',data,(response)=>{
                                        let responses = jQuery.parseJSON(response);
                                        if(responses.status=='Success'){
                                            $('#loading-box').addClass('d-none');
                                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/avans_onay_iptal',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/odeme_onay_iptal',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
...
$(document).on('click','.odeme_yap',function (){
    ...
    $.confirm({
        ...
        content: function () {
            ...
            $.post(baseurl + 'malzemetalepnew/accountlist',data,(response) => {
                self.$content.find('#person-list').empty().append(html);
                $('.select-box').select2({
                    dropdownParent: $(".jconfirm-box-container")
                });
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/transaction_create',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
...
$(document).on('click','.avans_price_update',function(){
    ...
    $.confirm({
        ...
        smoothContent: true,
        draggable: false,
        content: 'Talep Edeceğiniz Avans Miktarını Giriniz?<br><input type="number" value="'+avans_tutar+'" class="form-control avans_tutar">',
        buttons: {
            formSubmit: {
                text: 'Güncelle',
                btnClass: 'btn-blue',
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalepnew/avans_update',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalepnew/siparis_create',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                ...
                $.confirm({
                    ...
                    content: function () {
                     ...
                     <div class="card">
                        ...
                        let table_report='';
                        $.post(baseurl + 'malzemetalepnew/get_all_cari_list',data,(response) => {
                            self.$content.find('#person-list').empty().append(html);
                            let responses = jQuery.parseJSON(response);
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalepnew/teklif_create',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
...
$(document).on('click','.ihale_open',function (){
    ...
    $.post(baseurl + 'malzemetalepnew/ihale_open',data,(response)=>{
        let responses = jQuery.parseJSON(response);
        if(responses.status=='Success'){
            $('#loading-box').addClass('d-none');
            $.alert({
