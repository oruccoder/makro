        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/form_bildirim_olustur',data,(response)=>{
...
$(document).on('click','#tehvil_print',function (){
    ...
    if (checked_count == 0) {
        ...
        $.post(baseurl + 'malzemetalep/tehvil_print',data,(response)=>{
            let responses = jQuery.parseJSON(response);
...
$(document).on('click','.recete_item_remove',function (){
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'uretim/delete_item_form',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'uretim/upload_file',data,(response) => {
                        let responses = jQuery.parseJSON(response);
                        $('#loading-box').addClass('d-none');
                        if(responses.status=='Success'){
                            $.alert({
...
$(document).on('click','.form_add_cari',function (){
    ...
    $.post(baseurl + 'malzemetalep/form_cari_list_create',data,(response)=>{
        let responses = jQuery.parseJSON(response);
        if(responses.status=='Success'){
            $('#loading-box').addClass('d-none');
            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/delete_cari_form',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/product_price_details_add',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/update_form',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'uretim/delete_file',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
...
$(document).on('click','.yonetim_users',function (){
    ...
    $.confirm({
        ...
        content: function () {
            ...
            let table_report='';
            $.post(baseurl + 'malzemetalep/get_all_users',data,(response) => {
...
$(document).on('click','#search_button_cari',function (){
    ...
    if(keyword.length < 3){
        ...
        $.post(baseurl + 'malzemetalep/search_cari',data,(response)=>{
            let responses = jQuery.parseJSON(response);
            if(responses.status=='Success'){
                $('#loading-box').addClass('d-none');
                $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalep/odeme_create',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                        ...
                        buttons: {
                            formSubmit: {
                                ...
                                action: function () {
                                    ...
                                    $.post(baseurl + 'malzemetalep/avans_create',data,(response)=>{
                                        let responses = jQuery.parseJSON(response);
                                        if(responses.status=='Success'){
                                            $('#loading-box').addClass('d-none');
                                            $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalep/warehouse_talep_stock_update',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalep/siparis_senet_update',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalep/tehvil_senet_update',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                        ...
                        buttons: {
                            formSubmit: {
                                ...
                                action: function () {
                                    ...
                                    $.post(baseurl + 'malzemetalep/siparis_update',data,(response)=>{
                                        let responses = jQuery.parseJSON(response);
                                        if(responses.status=='Success'){
                                            $('#loading-box').addClass('d-none');
                                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/avans_onay_iptal',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/odeme_onay_iptal',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
...
$(document).on('click','.odeme_yap',function (){
    ...
    $.confirm({
        ...
        content: function () {
            ...
            $.post(baseurl + 'malzemetalep/accountlist',data,(response) => {
                self.$content.find('#person-list').empty().append(html);
                $('.select-box').select2({
                    dropdownParent: $(".jconfirm-box-container")
                });
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/transaction_create',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/avans_update',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalep/siparis_create',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
                ...
                $.confirm({
                    ...
                    content: function () {
                     ...
                     <div class="card">
                        ...
                        let table_report='';
                        $.post(baseurl + 'malzemetalep/get_all_cari_list',data,(response) => {
                            self.$content.find('#person-list').empty().append(html);
                            let responses = jQuery.parseJSON(response);
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.post(baseurl + 'malzemetalep/teklif_create',data,(response)=>{
                                    let responses = jQuery.parseJSON(response);
                                    if(responses.status=='Success'){
                                        $('#loading-box').addClass('d-none');
                                        $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/delete_item_form',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
...
$(document).on('click','.ihale_open',function (){
    ...
    $.post(baseurl + 'malzemetalep/ihale_open',data,(response)=>{
        let responses = jQuery.parseJSON(response);
        if(responses.status=='Success'){
            $('#loading-box').addClass('d-none');
            $.alert({
