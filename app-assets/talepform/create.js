        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/upload_file',data,(response) => {
                        let responses = jQuery.parseJSON(response);
                        $('#loading-box').addClass('d-none');
                        if(responses.status=='Success'){
                            $.alert({
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    $.post(baseurl + 'malzemetalep/delete_file',data,(response)=>{
                        let responses = jQuery.parseJSON(response);
                        if(responses.status=='Success'){
                            $('#loading-box').addClass('d-none');
                            $.alert({
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.post(baseurl + 'malzemetalep/anbar_asama_update',data,(response)=>{
                                let responses = jQuery.parseJSON(response);
                                if(responses.status=='Success'){
                                    $('#loading-box').addClass('d-none');
                                    $.alert({
