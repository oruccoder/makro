...
class Ihracat extends CI_Controller
{
    ...
    public function action()
    {
        ...
        if ($this->cost->addinvoice(
            ...
            $this->aauth->get_user()->id, $this->aauth->get_user()->loc,$payer,$method,$holder))
        {
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $invoices) {
            ...
            $row[] = round($invoices->total_qty,2);
    ...
    public function masraf_detay_ajax()
    {
        ...
        $output = array(
            ...
            "recordsFiltered" => $this->cost->count_all_masraf_detay($string,$id,$this->limited),
