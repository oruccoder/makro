...
class Personelisavanstalep Extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('Personelisavanstalep_model', 'model');
    }
    public function index()
    {
        $head['usernm'] = $this->aauth->get_user()->username;
        $head['title'] = 'Personel İş Avans Talep Formu';
        $this->load->view('fixed/header', $head);
        $this->load->view('personelisavans/index');
