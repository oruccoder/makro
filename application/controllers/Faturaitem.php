...
class Faturaitem extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Faturaitem_model', 'model');
        $this->load->library("Aauth");
    ...
    public function index()
    {
        ...
        if (!$this->aauth->premission(88)->read) {
            ...
            $head['title'] = "Envanter Tanımlamaları";

            $this->load->view('fixed/header', $head);

            $this->load->view('faturaitem/index');
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $item) {
            ...
            $view = "<a class='btn btn-info btn-sm ' href='/demirbas/item_views/$item->id/fatura_item' ><i class='far fa-eye'></i></a>&nbsp;";
