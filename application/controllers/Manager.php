...

{
...

    {
        ...
        echo json_encode(array('name' => $task['name']
        , 'description' => $task['description']
        , 'employee' => $task['emp']
        , 'assign' => $task['assign'], 'priority' =>$derece));
...

    {
        ...
        foreach ($list as $task) {
            ...
            if ($task->status == 'Done') {
                ...
                $name = '<a class="check text-success" data-id="' . $task->id . '" data-stat="Done"> 
                <i class="icon-check"></i> </a><a href="#" data-id="' . $task->id . '" class="view_task">' . $task->name . '</a>';
            ...
            $row[] = '<a href="#" class="btn btn-primary btn-sm rounded set-task" data-id="' . $task->id . '" data-stat="0"> Durum Değiştir </a>' . $name;
            ...
            $row[] = '<a href="#" data-id="' . $task->id . '" class="view_task btn-sm btn-indigo"> <i class="icon-eye"> Görüntüle</i> </a>';
