    ...
    public function template()
    {
        ...
        switch ($ttype) {
            ...
            case 'sayim':
                ...
                $link = "http://muhasebe.italicsoft.com/firma_login/token_giris.php?firma_kodu=$firma_kodu&id=$id&type=sayim_noti&token=$validtoken";
                break;
        ...
        switch ($ttype) {
            case 'notification':
                ...
                break;
            case 'sayim':
                $template = $this->templates->template_info(14);
                break;
