...
class Carigidertalep Extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('Carigidertalep_model', 'model');
    }
    ...
    public function ajax_list(){
        ...
        foreach ($list as $prd) {
            ...
            $view = "<a class='btn btn-success view' href='/carigidertalep/view/$prd->id' type='button'><i class='fa fa-eye'></i></a>&nbsp;";
    ...
    public function create_save(){
        if (!$this->aauth->premission(47)->write) {
            ...
            if($result['status']){
                ...
                echo json_encode(array('status' => 'Success', 'message' =>"Başarılı Bir Şekilde Talep Oluşturuldu",'index'=>'/carigidertalep/view/'.$result['id']));
    ...
    public function view($id)
    {
        ...
        $this->load->view('carigidertalep/view',$data);
        $this->load->view('fixed/footer');
    }
