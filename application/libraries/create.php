<div class="content-body">
            ...
            <div class="heading-elements">
				...
				<div class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Adınız"
                                   class="form-control margin-bottom b_input required" name="name" id="mcustomer_name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Firma hakkında Bilgi"
                ...
                <input type="text" placeholder="Firma Sektörü"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Telefon"
                                   class="form-control margin-bottom required b_input" name="phone" id="mcustomer_phone">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Email"
                                   class="form-control margin-bottom required b_input" name="email" id="mcustomer_email">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Adres"
                                   class="form-control margin-bottom b_input" name="address" id="mcustomer_address1">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="İlçe"
                                   class="form-control margin-bottom b_input" name="city" id="mcustomer_city">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Ülke"
                                   class="form-control margin-bottom b_input" name="country" id="mcustomer_country">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
							...
							<div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="link-tab" aria-expanded="false">
								  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Adı"
                                   class="form-control margin-bottom b_input" name="name_s" id="mcustomer_name_s">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Telefon"
                                   class="form-control margin-bottom b_input" name="phone_s" id="mcustomer_phone_s">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Email"
                                   class="form-control margin-bottom b_input" name="email_s" id="mcustomer_email_s">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="İlçe"
                                   class="form-control margin-bottom b_input" name="city_s" id="mcustomer_city_s">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Şehir"
                                   class="form-control margin-bottom b_input" name="region_s" id="region_s">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" placeholder="Ülke"
                                   class="form-control margin-bottom b_input" name="country_s" id="mcustomer_country_s">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" placeholder="Posta Kodu"
                                   class="form-control margin-bottom b_input" name="postbox_s" id="postbox_s">
                        </div>
                    </div>
							</div>
							<div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="link-tab2" aria-expanded="false">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="KDV Oranı"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" placeholder="<?php echo $this->lang->line('Customer Credit Amounth') ?>"
                                           class="form-control margin-bottom b_input" name="customer_credit">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="<?php echo $this->lang->line('Customer Teminat Description') ?>"
                                               class="form-control margin-bottom b_input" name="customer_teminat_desc">
                                    </div>
                                </div>
   ...
   <input type="submit" id="submit-data" class="btn btn-lg btn btn-primary margin-bottom round float-xs-right mr-2"
