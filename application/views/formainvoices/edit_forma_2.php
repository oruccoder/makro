<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Forma2 Düzenle</span></h4>
                ...
                <form method="post" id="data_form">
                    ...
                    <div class="col-sm-12 cmp-pnl">
                        ...
                        <div class="inner-cmp-pnl">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <select class="select-box form-control" id="customer_id" name="customer_id">
                                        ...
                                        {
                                            $select='';
                                            if($edit_data['csd']==$customers->id){
                                                $select='selected';
                                            }
                                            echo "<option $select name='$customers->company' value='$customers->id'>$customers->company</option>";
                                        } ?>
                                    </select>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-1">
                                    <label for="fis_no" class="caption">Ödemeler</label>
                                ...
                                <div class="col-sm-3"><label for="fis_no" class="caption">Protokoller</label>

                                    <div class="input-group">
                                        <div class="input-group-addon"><span class="icon-file-text-o"
                                                                             aria-hidden="true"></span></div>

                                        <select class="form-control select-box" id="hizmet_protokol" name="hizmet_protokol">
                                            <?php
                                            if(protokoller($edit_data['csd'])){

                                                foreach (protokoller($edit_data['csd']) as $value){

                                                    if(in_array($value->id,$muqavele_id))
                                                    {
                                                        ?>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <select class="form-control" name="kdv_durum">
                                        <?php if($edit_data['taxstatus']=='no') {
                                            ?>
                                            <option selected value="no">KDV Hariç</option>
                                            <option value="yes">KDV Dahil</option>
                                            <?php
                                        } else {
                                            ?>
                                            <option  value="no">KDV Hariç</option>
                                            <option selected  value="yes">KDV Dahil</option>
                                            <?php
                                        } ?>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <input class="form-control" name="kdv_oran" value="<?php echo isset($edit_data['tax_oran'])?$edit_data['tax_oran']:'' ?>">
                                </div>
                    ...
                    <div id="saman-row">
                        <table class="table datatable-show-all my_stripe">
                    ...
                    <input type="hidden" value="formainvoices/update" id="action-url">
...
<script>
    ...
    $(document).on('click','#submit-data-forma2',function (){
        $.confirm({
            ...
            smoothContent: true,
            draggable: false,
            content:'Forma 2 Güncellemek İstediğinizden Emin Misiniz?',
            buttons: {
                formSubmit: {
                    text: 'Evet',
                    btnClass: 'btn-blue',
