...
//        } ?>
        ...
        <tr>
            ...
            <td colspan="4" style="text-align: right">Forma2 Net Toplamı</td>
            <td><b><?php echo amountFormat($forma2_new_toplam )?></b></td>
        </tr>
        <tr>
            <td colspan="4" style="text-align: right"> KDV Toplamı (<?php echo round($invoice['tax_oran'],2).' %';?> )</td>
        ...
        <tr>
            <td colspan="4" style="text-align: right">Kalan (KDV HARİÇ)</td>
