                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-xs-6 col-sm-6 col-md-6">
                                        ...
                                        <div class="col-sm-12 row" style="padding: 0;">
                                            ...
                                            <div class="form-group col-sm-2">
                                                <label class="col-sm-12 col-form-label" for="product_name">ƏDV ORan</label>
                                                <div class="col-sm-12">
                                                    <input type="number" value="18"  id="edv_oran_form" class="form-control">
                                                </div>
                                            </div>
    ...
    $(document).on('click','.guncelle',function (){
        ...
        if(parseInt(method)){
            ...
            let data = {
                ...
                edv_oran_form : $('#edv_oran_form').val(),
            ...
            $.post(baseurl + 'hizmet/teklif_update',data,(response)=>{
