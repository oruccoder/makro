                        ...
                        <div class="row">
                            <div class="col-sm-12 cmp-pnl">
                                <table class="table">
                                    ...
                                    $teslim_alinmis = hizmet_teslim_alinmis($form_id,$items->product_id,$items->talep_form_product_id)['alinan_miktar'];
                                    ...
                                    <tr class="items_tr" data-eq="<?php echo $eq ?>">
                                        ...
                                        <td><?php echo "<div class='input-group '><input type='number' eq='$eq'  value='$teslim_alinmis' class='form-control item_qty' max='$teslim_alinmis' onkeyup='amount_max(this)' >" ?><span class="input-group-addon font-xs text-right"><?php echo $unit_name ?></span></div></td>
