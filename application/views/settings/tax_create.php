        ...
        <div class="card card-block">
            ...
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                          <select class="form-control round" name="ttype">   <option value="yes" data-tformat="yes">Exclusive</option>
                                            ...
                                            <option value="igst" data-tformat="igst"><?php echo $this->lang->line('IGST') ?></option>   </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6">
                      <select class="form-control round" name="ttype2">   <option value="yes" data-tformat="yes">Exclusive</option>
                                            <option value="inclusive"  data-tformat="incl"><?php echo $this->lang->line('Inclusive') ?></option>
                                           </select>
                    </div>
                </div>
