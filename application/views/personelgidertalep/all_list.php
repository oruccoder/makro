<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Personel Gider Talebi</span></h4>
...
<script>
    ...
    function draw_data() {
        $('#cari_gider_talep_list').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': "<?php echo site_url('personelgidertalep/ajax_list')?>",
                'type': 'POST',
                'data': {
...
<div class="form-row">
    <div class="form-group col-md-6">
      <label for="asama_id">Gider Yapılacak Personel</label>
        <select class="form-control select-box personel_id_talepeden">
...
<div class="form-row">
 <div class="form-group col-md-12">
      ...
      <input type='hidden' value='<?php echo $this->aauth->get_user()->id?>' id="firma_demirbas_id">
    </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-12">
                                        ...
                                        formSubmit: {
                                            ...
                                            action: function () {
                                                ...
                                                let data = {
                                                    ...
                                                    desc:  $('#desc').val(),
                                                    firma_demirbas_id:  $('.personel_id_talepeden').val(),
                                                    demirbas_id:  demirbas_id,
                                                    image_text:  $('#image_text').val(),
                                                    talep_eden_user_id:  $('.personel_id_talepeden').val(),
                                                }
                                                $.post(baseurl + 'personelgidertalep/create_save',data,(response) => {
                                                    let responses = jQuery.parseJSON(response);
