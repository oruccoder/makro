<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Gider Görüntüle</span></h4>
                                            ...
                                            <div id="invoice-template" class="card-body">
                                                ...
                                                <div class="">
                                                    ...
                                                    if ($invoice['status'] != 'canceled') { ?>
                                                        ...
                                                        <a href="<?php echo 'gider_edit?id=' . $invoice['id']; ?>" class="btn btn-warning mb-1"><i
                            ...
                            -->
                                                        ...
                                                        <div class="btn-group ">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                   href="<?php echo 'giderprintinvoice?id=' . $invoice['id']; ?>" target="_blank"><?php echo $this->lang->line('Print') ?></a>

                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item"
                                                                   href="<?php echo 'giderprintinvoice?id=' . $invoice['id']; ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
                                                        ...
                                                        <div class="btn-group ">
                                                            ...
                                                            <a href="#odeme_emri" data-toggle="modal" data-remote="false"
                                                               class="btn btn-success mb-1">Ödeme Emri Ver</a>
                                                        </div>
...
-->
                                                ...
                                                <div id="invoice-company-details" class="row mt-2">
                                                    ...
                                                    <div class="col-md-8 col-sm-12 text-xs-center text-md-right">
                                                        <h2>Gider Talep Formu</h2>
                                                        <p class="pb-1"> <?php echo $this->config->item('prefix') . ' #' . $invoice['talep_no'] . '</p>'; ?>
                                                            <?php if($invoice['cari_pers']==1){
                                                            ?>
                                                        <p style="font-size: 17px" class="pb-1">Talep Eden Personel : <span style="font-weight: 900"><?php echo personel_details($invoice['talep_eden_pers_id']) ?></span> </p>
                                                        <?
                                                        }
                                                        else {
                                                            ?>
                                                            <p style="font-size: 17px" class="pb-1">Talep Eden Cari : <span style="font-weight: 900"><?php echo customer_details($invoice['talep_eden_pers_id'])['company'] ?></span> </p>
                                                            <?
                                                        }?>


                                                        <p class="pb-1">Talep Oluşturan Personel : <?php echo personel_details($invoice['kullanici_id']) ?> </p>


                                                        <?php
                                                        if($invoice['transaction_id']!=0){
                                                            $inv_id=$invoice['transaction_id']; ?>
                                                            <a href="/transactions/view?id=<?php echo $inv_id; ?>" class='btn btn-info'>Ödemeyi Görüntüle</a>
                                                        <?php  } ?>
...
//                                        }
                           ...
                           '.$price_str.'
                            ...
                            <td>' .purchase_status(onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"proje_sorumlusu_status")['durum']).'<br>'.onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"proje_sorumlusu_status")['note'].'</td>
                            <td>' .purchase_status(onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"proje_muduru_status")['durum']).'<br>'.onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"proje_muduru_status")['note'].'</td>
                            <td>' .purchase_status(onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"bolum_muduru_status")['durum']).'<br>'.onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"bolum_muduru_status")['note'].'</td>
                            <td>' .purchase_status(onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"genel_mudur_status")['durum']).'<br>'.onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"genel_mudur_status")['note'].'</td>
                            <td>' .purchase_status(onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"finans_status")['durum']).'<br>'.onay_durumlari_ogren_product_str(4,$_GET['id'],$product_id,"finans_status")['note'].'</td>
...
<script>
    $(document).on('click',"#tumunu_onayla",function(e) {
        ...
        jQuery.ajax({
            url: baseurl + 'form/gider_talep_product_status_toplu',
            type: 'POST',
    ...
    $(document).on('click', ".onayla,.iptal", function (e) {
        ...
        jQuery.ajax({
            url: baseurl + 'form/gider_talep_product_status',
            type: 'POST',
            data: {
    ...
    $(document).on('click', ".islem_bitir", function (e) {
        ...
        jQuery.ajax({
            url: baseurl + 'form/gider_talep_islem_bitir',
            type: 'POST',
            data: {
                'talep_id':talep_id,
                'pers_id':pers_id,
