                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <label class="col-form-label"><?php echo $this->lang->line('proje name') ?></label>

                                    <div class="input-group">

                                        <input type="text" class="form-control " name="proje_name" value="<?php echo $invoice['proje_name'] ?>" id="proje_name"
                                               placeholder="Proje"
                                               autocomplete="off"/>
                                ...
                                <div class="col-md-1">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control Tarihi required" id="tsn_due"  value="<?php echo dateformat($invoice['olusturma_tarihi']) ?>"
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <select class="form-control finans_mudur_id" name="finans_mudur_id">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <label for="taxformat" class="col-form-label">Cari/Personel</label>
                                    ...
                                    <?php if($invoice['cari_pers']==1)
                                    {
                                        ...
                                        ?>
                                        <input type="text" class="form-control" disabled value="Personel">
                                        <?php
                                    }
                                    else if($invoice['cari_pers']==2)
                                    {
                                        $invoice_name=invoice_details($invoice['invoice_id'])->invoice_no;
                                        $pers_cari=customer_details($invoice['talep_eden_pers_id'])['company'];
                                        ?>

                                        <input type="text" class="form-control" disabled value="Cari">
                                        <?php
                                    }
                                    ?>


                                    <input type="hidden" name="cari_pers" value="<?php echo $invoice['cari_pers'];?>">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="hidden" name="talep_eden_pers_id" value="<?php echo $invoice['talep_eden_pers_id'];?>">
                                    <input type="text" class="form-control" disabled value="<?php echo $pers_cari;?>">

                                </div>

                                <?php if($invoice['talep_or_invoice']==1){ ?>

                                <div class="col-sm-2">
                                    <label for="taxformat" class="col-form-label">Faturalar</label>
                                    <input type="hidden" name="invoice" value="<?php echo $invoice['invoice_id'];?>">
                                    <input type="text" class="form-control" disabled value="<?php echo $invoice_name;?>">
                                </div>

                                <?php } else {  ?>
                                    <div class="col-sm-2">
                                        <label for="taxformat" class="col-form-label">Satınalma Formu</label>
                                        <input type="hidden" name="invoice" value="<?php echo $invoice['invoice_id'];?>">
                                        <input type="text" class="form-control" disabled value="<?php echo talep_details($invoice['invoice_id'])->talep_no;?>">
                                    </div>
                                <?php }  ?>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" placeholder="description"
                                               ...
                                               value="<?php echo $invoice['description'];?>">
                                    </div>
                                </div>
                    ...
                    <div id="saman-row" >
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control product_name" name="product_name[]" id="product_name-' . $i . '" value="'.$row['product_name'].'">
                                </td>
                                <td>
                                    <input type="text" class="form-control unit" id="unit-' . $i . '" value="'.units_($row['unit'])['name'].'">
                                    <input type="hidden" name="unit[]" id="unit_id-' . $i . '" value="'.$row['unit'].'">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="product_detail[]" id="product_detail-' . $i . '" value="'.$row['product_detail'].'" >
                                </td>
                                <td><input type="text" class="form-control req amnt" name="product_qty[]" id="amount-' . $i . '"  value="'.$row['qty'].'"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal_gider(' . $i . '), billUpyog_gider()"
                                           autocomplete="off" value="1"><input type="hidden" id="alert-' . $i . '" value="'.$row['qty'].'" name="alert[]"> </td>


                                <td><input type="text" class="form-control req prc" name="product_price[]" id="price-' . $i . '" value="'.$row['price'].'"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal_gider(' . $i . '), billUpyog_gider()"
                                           autocomplete="off"></td>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" class="form-control discount" name="product_discount[]"
                                           ...
                                           onkeyup="rowTotal_gider(' . $i . '), billUpyog_gider()" autocomplete="off">
                                    <strong><span class="ttlText" id="result-0">'.$row['subtotal'].'</span><span class="currenty"> AZN</span></strong>
...
<button type="button" data-rowid="' . $i . '" class="btn btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button>
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="5" align="right">
                                    <input type="hidden" value="<?php echo $invoice['subtotal'] ?>" id="subttlform"  name="subtotal">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="left" colspan="2"><input type="text" name="total" class="form-control"
                                                                    id="invoiceyoghtml" value="<?php echo $invoice['total']; ?>" readonly="">
                    ...
                    <input type="hidden" value="form/edit_avans" id="action-url">
                    <input type="hidden" value="<?php echo $_GET['id'] ?>" id="talep_id" name="talep_id">
