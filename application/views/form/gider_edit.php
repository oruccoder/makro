                                ...
                                <div class="col-md-2" hidden>
                                    ...
                                    <div class="input-group">
                                        <input type="text" placeholder="Bölüm Adı"
                                               class="form-control margin-bottom " value="<?php echo $invoice['bolum_adi'] ?>" name="bolum_adi" autocomplete="false"
                                        >
                                    </div>
                                </div>
                        ...
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <strong><span class="ttlText" id="result-' . $i . '">'.$row['subtotal'].'</span><span class="currenty"> AZN</span></strong>
...
<button type="button" data-rowid="' . $i . '" class="btn btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button>
                    ...
                    <input type="hidden" value="form/edit_action_gider" id="action-url">
