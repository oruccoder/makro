...
<div class="invoice-box">
    ...
    <table class="plist" cellpadding="0" cellspacing="0">
        ...
        foreach ($products as $row) {
            ...
            echo '<tr>
                    ...
                    <td width="40%">'.$row['product_detail'].'</td>
                    <td width="10%">' . +$row['qty'].' '.units_($row['unit'])['name']. '</td>
                    <td width="10%">' . amountFormat($row['price']). '</td>
                    <td width="10%">' . amountFormat($row['subtotal']). '</td>
                </tr>';
    ...
    <p style="font-size: 10px">
        Açıklama :<?php echo $invoice['description'] ?>
    </p>
