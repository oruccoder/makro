<p style="font-size: 10px">* Yukarıda yazılı olan ürünleri miktarları ile eksiksiz olarak teslim aldım.</p><br><br>
<footer style="padding-bottom: 90px">

    <table  style="font-size: 12px">

        <tr>
            <td style="text-align: center"><b>Tehvil Alan Sorumlu</b></td>
            <td style="text-align: center"><b>Teslim Eden Sorumlu</b></td>
        </tr>
        <tr>
