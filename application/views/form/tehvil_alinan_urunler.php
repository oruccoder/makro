<div class="col-xl-12 col-lg-12">
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h4 class="card-title" style="text-align: center;font-size: 20px;font-weight: 600;font-family: inherit;">Tehvil Alınan Ürünler</h4>
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="btn-group box-shadow--8dp" role="group" style="background-color: white;margin: 8px 0px 8px 0px;border-radius: 3px !important;" >

                        <select class="form-control select2" id="talep_no" name="talep_no" style="width: 297px !important;">
                            <option value="0">Talep No</option>
                            <?php
                            foreach (talep_list(2) as $agd) {?>
                                <option value="<?php echo $agd->id ?>"><?php echo $agd->talep_no ?></option>
                        ...
                        &nbsp;   &nbsp;
                        <select class="form-control select2" id="firma_id" name="firma_id" style="width: 297px !important;">
                            <option value="0">Firma</option>
                            <?php
                            foreach (all_customer() as $agd) {?>
                                <option value="<?php echo $agd->company ?>"><?php echo $agd->company ?></option>

                            <?php } ?>

                        </select>
                        &nbsp;   &nbsp;
                        <select class="form-control select2" id="pers_id" name="pers_id" style="width: 297px !important;">
                            <option value="0">Tehvil Alan Personel</option>
                            <?php
                        ...
                        &nbsp;   &nbsp;
                        <select class="form-control select2" id="status_id" name="status_id" style="width: 297px !important;">
                            <option value="0">Durum</option>
                            <?php
                            foreach (depo_urun_status() as $agd) {?>
                                <option value="<?php echo $agd->id ?>"><?php echo $agd->name ?></option>
                        ...
                        <div class="col-md-2">
                            <input type="text" name="start_date" id="start_date" data-toggle="filter_date"
                                   class="form-control form-control-md" autocomplete="off" placeholder="Tevhil Baş. Tarihi"/>
                        </div>
                        <div class="col-md-2">
                            <input type="text" name="end_date" id="end_date" class="form-control form-control-md"
                                   data-toggle="filter_date" autocomplete="off" placeholder="Tehvil Bit. Tarihi"/>
                        </div>
...
<script>
    ...
    $('#search').click(function () {
        ...
        $('#invoice_urunler').DataTable().destroy();
        draw_data5(talep_no, proje_id,firma_id,pers_id,status_id,start_date,end_date);
    });
