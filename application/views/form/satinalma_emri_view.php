                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item"
                                       href="<?php echo 'satinalmaemri_print?id=' . $invoice['id']; ?>" target="_blank"><?php echo $this->lang->line('Print') ?></a>

                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                       href="<?php echo 'satinalmaemri_print?id=' . $invoice['id']; ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
...
-->
                    ...
                    <div id="invoice-company-details" class="row mt-2">
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
                            ...
                            <p class="pb-1"> <?php echo $this->lang->line('project_name') . ': ' . $invoice['proje_name'] . '</p>';?>
                            <p class="pb-1"> <?php echo 'Talep Eden: '. personel_details($invoice['talep_eden_pers_id']).'</p>';?>
                            <p class="pb-1"> <?php echo 'Proje Müdürü: '. personel_details($invoice['proje_muduru_id']).'</p>';?>
                            <p class="pb-1"> <?php echo 'Satın Alma Sorumlusu: '. personel_details($invoice['satinalma_personeli']).'</p>';?>
                        </div>
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                            <h2>Satın Alma Emri</h2>
                    ...
                    <div id="invoice-customer-details" class="row">
                        ...
                        <div class="offset-md-3 col-md-3 col-sm-12 text-xs-center text-md-right">
                            <?php echo '<p><span class="text-muted">'.$this->lang->line('creation date').'  :</span> ' . dateformat($invoice['olusturma_tarihi']) . '</p> 
                            ';
                            ?>
                        </div>
                    </div>
                    ...
                    <div id="invoice-items-details" class="pt-2">
                        <div class="row">
                            <div class="table-responsive col-sm-12">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th width="8%" class="text-center">Miktar / Birim</th>
                                        <th width="15%" class="text-center">KDV'siz Birim Alış Fiyatı</th>
                                        <th width="15%" class="text-center">KDV'li Birim Alış Fiyatı</th>
                                        <th width="15%" class="text-center">KDV'siz Tutar</th>
                                        <th width="15%" class="text-center">KDV'li Tutar</th>
                            ...
                            <td>' . $row['qty'] .' '. $row['unit'] . '</td>               
                             ...
                             <td>' . amountFormat($kdv_li) . '</td>          
                             <td>' . amountFormat($kdv_siz_tutar) . '</td>          
                             <td>' . amountFormat($kdv_li_tutar) . '</td>          
                             <td>' . personel_details($row['satin_alma_pers_item_id']) . '</td>          
                                ...
                                <div class="table">
                                    <table class="table-responsive">
                                        <tr>
                                            ...
                                            <th>Bölüm Müdürü Durumu</th>
                                            <th>Finans Departmanı Durumu</th>
                                            <th>Genel Müdür Durumu</th>
                                        </tr>
                                        <tbody>

                                        <tr>
                                            <td><?php echo purchase_status(onay_durumlari_ogre(3,$_GET['id'],'hazirlayan_status')) ?></td>
                                            <td><?php echo purchase_status(onay_durumlari_ogre(3,$_GET['id'],'proje_muduru_status')) ?></td>
                                            <td><?php echo purchase_status(onay_durumlari_ogre(3,$_GET['id'],'bolum_muduru_status')) ?></td>
                                            <td><?php echo purchase_status(onay_durumlari_ogre(3,$_GET['id'],'finans_status')) ?></td>
                                            <td><?php echo purchase_status(onay_durumlari_ogre(3,$_GET['id'],'genel_mudur_status')) ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
