                ...
                <div id="invoice-template" class="card-body" style="    text-align: center;">
                    ...
                    <div id="invoice-company-details" class="row mt-2">
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-left">
                            ...
                            <p class="font_11">Satın Alma Talep Formu</p>
                                ...
                                <form id="data_form" type="POST">
                                    <table class="table-responsive">
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            $alt_file_id = $row['id'];
                                            if(onay_durumlari_ogren_product_sf(2,$_GET['id'],$alt_file_id))
                                            {
                                                ...
                                                echo '<tr>
                                                    ...
                                                    <td style="font-size: 8px;">' . $row['firma'] . '</td>             
                                                    ...
                                                    <input type="hidden" class="product_id" name="product_id[]" value="'.$alt_file_id.'">
                                        ...
                                        <tr>
                                            <th colspan="4" scope="row"><button id="tumunu_onayla" type="button" class="btn btn-info btn-xs">Tümünü Təstiqle</button></th>
                                            <th colspan="4" scope="row"><button style="float: right;" class="btn btn-info btn-xs islem_bitir">İşlemi Bitir</button></th>
                                        </tr>
                                        <tr>
