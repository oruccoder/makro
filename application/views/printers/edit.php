                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="Printer Name"
                               class="form-control margin-bottom  required" name="p_name" value="<?php echo $printer['val1'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select class="form-control" name="p_type">
                            <option    value="<?php echo $printer['val2'] ?>">--Keep Current- <?php echo $printer['val2'] ?></option>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="Printer Connector"
                               class="form-control margin-bottom required" name="p_connect" value="<?php echo $printer['val3'] ?>">
                    </div>
                </div>
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="lid" class="form-control">
                                 <option    value="<?php echo $printer['val4'] ?>">- <?php $loc=location($printer['val4']); echo $loc['cname'] ; ?>-</option>
                                <?php
