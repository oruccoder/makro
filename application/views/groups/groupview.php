<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-semibold"> <?php echo $this->lang->line('Client Group') . ' ' . isset($group['title']) ?></span>
            </h4>
...
<div class="content">
    <div class="card">
        <div class="card-body">
            ...
            <a href="#sendMail" data-toggle="modal" data-remote="false" class="btn btn-primary btn-sm"><i class="fa fa-envelope"></i> <?php echo $this->lang->line('Send Group Message') ?> </a>
            ...
            <div class="table datatable-responsive">
                <table id="fclientstable" class="display" cellspacing="0">
                    <thead>
                    <tr>
                        <th>#</th>
                    ...
                    <div class="row">
                        <div class="col-xs-12 mb-1"><label
                            ...
                            <input type="text" class="form-control"
                                   value="<?php echo isset($group['title']) ?>"></div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 mb-1"><label
