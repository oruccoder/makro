<script src="<?php echo base_url(); ?>assets/myjs/loading-bar.js" type="text/javascript"></script><article class="content content items-list-page">
    <div class="card card-block">
        ...
        <div class="card card-block">
            ...
            <hr>
            <h5>Current Version <?php echo $version ?> / <small>Build:<?php echo $build ?></small></h5><hr>
...
<span id="ldBar2" class="text-xs-center"
            ...
            <p id="step1"><span id="ldBar" class="text-xs-center"
                        ...
                        ></span>
                You can download and install updates with few click with this easy WebUpdater. Please remember this function will not work properly if your server has very restricted file permissions. You have to
            <br><br><button type="button"
                        class="update_chart btn btn-primary btn-min-width btn-lg mr-1 mb-1"
                        id="download_update">1. Check & Download Update</button>
 ...
 <?php  // }  if($this->session->userdata('step')){  ?>
            ...
            <span id="insldBar" class="text-xs-center"
                ...
                <button type="button"
                        ...
                        id="install_update">2. Update Files</button>
            </p>
             <p>
  <hr>
            </p>
 <?php // }  if($this->session->userdata('step')==2){  ?>
            ...
            <span id="dbldBar" class="text-xs-center"
                ...
                <button type="button"
                        ...
                        id="db_update">3. Update Database</button>
            </p>
            <?php // } ?>
        </div>
    </div>
