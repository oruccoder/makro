                        ...
                        $.confirm({
                            ...
                            ?>
                                                     ...
                                                     <div class="col-md-12 pb-2">
                                                        <label><span class="req">*</span>Stok Adı AZ</label>
                                                        <input type="text" class='form-control product_name required_input'>
                                                     </div>
                                                          <div class="col-md-12 pb-2">
                                                    ...
                                                    <div class="col-md-4 pb-2">
                                                        <label><span class="req">*</span>Marka</label>
                                                        <input type="text" class='form-control marka required_input'>
                                                    </div>
                                                       <div class="col-md-12 pb-2">
                                                    <hr>
                                                    </div>
                                                    <div class="col-md-3 pb-2">
                                                        <label><span class="req">*</span>Kalınlık</label>
                                                        <input type="text" class='form-control kalinlik required_input'>
                                                    </div>
                                                      <div class="col-md-3 pb-2">
                                                        <label><span class="req">*</span>En (mm)</label>
                                                        <input type="text" class='form-control en required_input'>
                                                    </div>
                                                    <div class="col-md-3 pb-2">
                                                        <label><span class="req">*</span>Boy (mm)</label>
                                                        <input type="text" class='form-control boy required_input'>
                                                    </div>
                                                    <div class="col-md-3 pb-2">
                                                        <label><span class="req">*</span>Yükseklik (mm)</label>
                                                        <input type="text" class='form-control yukseklik required_input'>
                                                    </div>
                                                    <div class="col-md-3 pb-2">
                                                        <label><span class="req">*</span>Yoğunluk</label>
                                                        <input type="text" class='form-control yogunluk required_input'>
                                                    </div>
                                                      <div class="col-md-3 pb-2">
                                                        <label><span class="req">*</span>İç Çap (mm)</label>
                                                        <input type="text" class='form-control ic_cap required_input'>
                                                    </div>
                                                    <div class="col-md-3 pb-2">
                                                        <label><span class="req">*</span>Dış Çap (mm)</label>
                                                        <input type="text" class='form-control dis_cap required_input'>
                                                    </div>
                                                    <div class="col-md-3 pb-2">
                                                        <label><span class="req">*</span>t (mm)</label>
                                                        <input type="text" class='form-control t required_input'>
                                                    </div>
                                                     <div class="col-md-8 pb-2">
                                                        <label><span class="req">*</span>Kullanım Yeri</label>
                                                        <textarea type="text" class='form-control kullanim_yeri required_input' id="kullanim_yeri" rows="4" cols="50"></textarea>
                                                    </div>
                                                       <div class="col-md-4 pb-2">
                                                        <label><span class="req">*</span>Renk</label>
                                                        <input type="text" class='form-control color required_input'>
                                                    </div>
                                                    <div class="col-md-12 pb-2">
                                                    <hr>
                                                    </div>
                                ...
                                echo "<option value='$id'>$name</option>";
                                                              ...
                                                              <div class="col-md-6 pb-2">
                                                                ...
                                                                <input type="text" class='form-control ean'>
                                                                  ...
                                                                  <div class="col-md-6 pb-2">
                                            <label><span class="req">*</span>Ürün Aciqlamasi</label>
                                                <textarea type="text" class='form-control product_description required_input' rows="4" cols="50" id="product_description"></textarea>
                                          </div>
                                           <div class="col-md-6 pb-2">
                                            <label><span class="req">*</span>Ürün Resmi</label>
                            ...
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function() {
                                        ...
                                        let required_input = $('.required_input').val();

                                        let marka = $('.marka').val();
                                        let product_name = $('.product_name').val();
                                        let kalinlik = $('.kalinlik').val();
                                        let en = $('.en').val();
                                        let boy = $('.boy').val();
                                        let yukseklik = $('.yukseklik').val();
                                        let yogunluk = $('.yogunluk').val();
                                        let ic_cap = $('.ic_cap').val();
                                        let dis_cap = $('.dis_cap').val();
                                        let t = $('.t').val();
                                        let kullanim_yeri = $('.kullanim_yeri').val();
                                        let color = $('.color').val();

                                        if(  (!isEmptyTF(product_name)) || (!isEmptyTF(marka)) ||
                                            (!isEmptyTF(kalinlik)) ||
                                            (!isEmptyTF(en)) ||
                                            (!isEmptyTF(boy)) ||
                                            (!isEmptyTF(yukseklik)) ||
                                            (!isEmptyTF(yogunluk)) ||
                                            (!isEmptyTF(kullanim_yeri)) ||
                                            (!isEmptyTF(ic_cap)) ||
                                            (!isEmptyTF(dis_cap)) ||
                                            (!isEmptyTF(t)) ||
                                            (!isEmptyTF(color))
                                        ){
                                            $('.required_input').css('border-color','red')
                                            $.alert({
                                                theme: 'material',
                                                ...
                                                title: 'Dikkat!',
                                                content: 'Zorunlu Alanları Doldurunuz',
                                                buttons: {
                                                    prev: {
                                                        text: 'Tamam',
...
<textarea class="form-control tag">`+tag_value+`</textarea>
            ...
            content: function() {
                ...
                ?>
                                                      ...
                                                      <div class="col-md-12 pb-2">
                                                        ...
                                                        <button type="button" class='btn btn-outline-secondary new_code_uret' product_id ='`+product_id+`' >Ürün Kodu Üret</button>
                                                     </div>
                                                     <div class="col-md-12 pb-2">
                                                        <label>Stok Adı AZ</label>
                                                        <input type="text" class='form-control product_name'>
    ...
    $(document).on('click','.new_code_uret',function (){
        let data_post = {
          product_id : $(this).attr('product_id')
        };

        $.post(baseurl + 'urun/new_code_create', data_post, (response) => {
            let data = jQuery.parseJSON(response);
            if (data.code == 200) {
                $.alert({
                    theme: 'modern',
                    ...
                    buttons: {
                        prev: {
                            ...
                            btnClass: "btn btn-link text-dark",
                            action: function() {
                                $('.product_code').val(data.new_code);
                            }
                        }
                    }
                });
