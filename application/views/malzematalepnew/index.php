                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(1)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(2)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(3)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(4)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(5)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(6)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"> <?php echo talep_status_count(7)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(8)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(9)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(10)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <span class="h2_ font-weight-bold mb-0"><?php echo talep_status_count(11)?></span>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                                                            <i class="fa fa-question"></i>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="#">
                            <div class="form-group row">
                                <div class="col-lg-2">
                                    <select class="select-box form-control" id="tansfer_status" name="tansfer_status" >
                                        <option value="-1">Transfer Durumu</option>
...
<script type="text/javascript">
    ...
    function draw_data(status_id=0,transfer_status=-1) {
        $('#invoices').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': "<?php echo site_url('malzemetalepnew/ajax_list')?>",
                'type': 'POST',
  ...
  <div class="form-row">
    <div class="form-group col-md-8">
     ...
     <div class="form-group col-md-4">
      <label for="talep_eden_user_id">Satınalama Birimi</label>
      <select class="form-control select-box required" id="satinalma_birimi">
       <option value="1">Baş Ofis</option>
       <option value="2">Şantiye</option>
    </select>
</div>
</div>
<div class="form-row">
 <div class="form-group col-md-3">
      <label for="talep_eden_user_id">Talep Türü</label>
      <select class="form-control select-box required" id="talep_type">
 ...
 <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-2">
      <label for="firma_id">Transfer</label>
        ...
        <div class="form-group col-md-2">
      <label for="firma_id">Gider Durumu</label>
 ...
 <div class="form-row proje_gider_talebi_visable d-none">
                                ...
                                formSubmit: {
                                    ...
                                    action: function () {
                                        ...
                                        let data = {
                                            ...
                                            satinalma_birimi:  $('#satinalma_birimi').val(),
                                            desc:  $('#desc').val(),
                                        ...
                                        $.post(baseurl + 'malzemetalepnew/create_save',data,(response) => {
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalepnew/status_upda',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status==200){
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalepnew/transfer_bildirimi',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status==200){
                                $.alert({
