<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">PAROLANIZI GÜNCELLEYIN  ( <?php echo $user['username'] ?> )</span></h4>
        </div>
    </div>
</div>
<style>
            ...
            <div class="card-body">
                <form id="product_action">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="Mevcut Parolanız"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="Yeni Parolanız"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="Tekrar Yeni Parolanız"
