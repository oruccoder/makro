                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select name="status" class="form-control">
                            <?php echo"<option value='Due'>".$this->lang->line('Task Due')."</option>
                            <option value='Done'>".$this->lang->line('Task Done')."</option>
                            <option value='Progress'>".$this->lang->line('Task Progress')."</option>";
							?>
