<div class="content-body">
    <div class="card">
         <div class="card-header">
            <h3 class="title">
                    <?php echo $this->lang->line('Tasks') ?>
                      <a href="<?php echo base_url('tools/addtask') ?>" class="btn btn-primary btn-sm rounded">
        ...
        <div class="tab-content px-1 pt-1">
                            ...
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body text-xs-left">
                                        ...
                                        <span><?php echo $this->lang->line('Task Due') ?></span>
                                    </div>
                            ...
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body text-xs-left">
                                        ...
                                        <span><?php echo $this->lang->line('Task Progress') ?></span>
                                    </div>
                                    <div class="media-right media-middle">
                            ...
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body text-xs-left">
                                        ...
                                        <span><?php echo $this->lang->line('Task Done') ?></span>
                                    </div>
                                    <div class="media-right media-middle">
            ...
            <table id="todotable" class="table table-striped table-bordered zero-configuration" class="display" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>#</th>
