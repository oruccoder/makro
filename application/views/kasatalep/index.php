<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Personel Kasa Avans Talebi</span></h4>
...
<script>
    ...
    var url = '<?php echo base_url() ?>kasatalep/file_handling';
    $(document).ready(function () {
        ...
        function draw_data() {
            $('#cari_gider_talep_list').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('kasatalep/ajax_list')?>",
                    'type': 'POST',
                    'data': {
...
<div class="form-row">
    <div class="form-group col-md-12">
      <label for="asama_id">Talep Ettiğiniz Kasanızı Seçiniz</label>
        <select class="form-control select-box account_id" id="account_id">
           <?php foreach (pay_type_next_process(1,0,0,1)['account_list'] as $emp){
                                $emp_id=$emp->id;
                                $name=$emp->holder;
                                ?>
                                ...
                                buttons: {
                                    formSubmit: {
                                        ...
                                        action: function () {
                                            ...
                                            $.post(baseurl + 'kasatalep/create_save',data,(response) => {
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'kasatalep/status_upda',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
