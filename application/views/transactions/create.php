            ...
            <div class="tab-content px-1 pt-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="customerpanel" class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control required" id="cari_pers_type" name="cari_pers_type" >
                                ...
                                <div class="frmSearch">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10" >
                                            <input type="text" class="form-control" name="cst" id="trans-box" placeholder="Müşteri / Personel Adı veya Telefon Numarası Giriniz" autocomplete="off"/>
                                ...
                                <div id="customerpanel" class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="hidden" name="masraf_id" id="masraf_id" value="0">
                                        <input type="hidden" name="invoice_id_masraf" id="invoice_id_masraf" value="0">
                                        <input type="text" class="form-control required" name="payer_name" id="company_name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <select name="paymethod" class="form-control required" id="paymethod">
                                                <option value="">Seçiniz</option>
                                ...
                                <div class="form-group row cari_in_invoice" style="visibility: hidden">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <select name="cari_in_invoice" class="form-control select-box" id="cari_in_invoice">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" placeholder="Tutar" class="form-control margin-bottom  required" name="amount" id="amount">
                                    </div>
                                </div>
                ...
                <input id="fileupload" type="file" name="files[]">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="caption col-sm-2 col-form-label">KDV İşle</label>
                                    <div class="col-sm-10">
                                        <input type="checkbox" name="kdv_durumu" id="kdv_durumu" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <select name="pay_type_kdv" class="form-control" id="pay_type_kdv">
                                                <?php foreach (transaction_type_kdv() as $row) {
                                                    echo '<option value="' . $row['id'] . '">' . $row['description'] . '</option>';
                                                } ?>
                                            </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <select name="paymethod_kdv" class="form-control" id="paymethod_kdv">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="pay_acc_kdv" class="form-control pay_acc_kdv">
                                            <option>Ödeme Türü Seçiniz</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" placeholder="Tutar"
                                               class="form-control margin-bottom" name="amount_kdv" id="amount_kdv">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" placeholder="Note"
                                               class="form-control" name="note_kdv" id="note_kdv">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
                ...
                $('#fileupload').fileupload({
                    ...
                    formData: {'<?=$this->security->get_csrf_token_name()?>': crsf_hash},
                        ...
                        $.each(data.result.files, function (index, file) {
                            $('#files').html('<tr><td><a data-url="<?php echo base_url() ?>transactions/file_handling?op=delete&name=' + file.name + '" class="aj_delete"><i class="btn-danger btn-sm icon-trash-a"></i> ' + file.name + ' </a><img style="max-height:200px;" src="<?php echo base_url() ?>userfiles/product/'+file.name + '"></td></tr>');
                            img=file.name;
                        });
            ...
            $(document).on('change', "#paymethod,#pay_type", function (e) {
                ...
                if(tur_id==2)
                {
                    ...
                    if(pay_type==12 || pay_type==14 || pay_type==16 || pay_type==4 || pay_type==49 || pay_type==50 || pay_type==51 || pay_type==52 || pay_type==59 || pay_type==60 )
                    {
                ...
                else  if(tur_id!=3)
                {
                    ...
                    if(pay_type==17 || pay_type==18 || pay_type==19 || pay_type==20 || pay_type==43 || pay_type==44 || pay_type==45 || pay_type==46 || pay_type==54 || pay_type==61|| pay_type==55 || pay_type==57|| pay_type==65 )
                    {
                ...
                if(pay_type==45 || pay_type==46 || pay_type==54 || pay_type==61|| pay_type==55 || pay_type==57)
                {
                    $('#cari_in_invoice').addClass('required vrequired');
                }
                else {
                    $('#cari_in_invoice').removeClass('required vrequired');
                }
            ...
            $(document).on('change', "#cari_in_invoice", function (e) {
                ...
                var invoice_no = $('option:selected', this).attr('invoice_no');
                $('#notes').val(invoice_no+' Numaralı Qaimeye Esasen Ödenish');
                $('#amount').val(kalan);
            ...
            function selectFactor(cid, cname, cadd1, cadd2, ph, email,discount=0,kalan_kredi,kredi,invoice_type,company,masraf_id,total) {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: baseurl + 'search_products/credit_sorgu',
                    data:
                        'credit='+ kredi+
                    ...
                    success: function (data) {
                        ...
                        else
                        {
                            ...
                            $('#masraf_id').val(masraf_id);
                            $('#invoice_id_masraf').val(cadd2);
                            $('#customer_company').html('<strong>'+company+'</strong>');
                            $('#customer_name').html('<strong>'+cname+'</strong>');
                            $('#company_name').val(company);
                            $('#customer_address1').html('<strong>'+cadd1+'<br>'+cadd2+'</strong>');
                            $('#customer_phone').html('Telefon: <strong>'+ph+'</strong><br>Email: <strong>'+email+'</strong>');
                            $('#customer_credit').html('Tanımlanan Kredi : <strong>'+kredi+'</strong>');
                            $('#customer_kalan_credit').html('Kalan Kredi : <strong>'+kalan_kredi+'</strong>');
                            $("#customer-box").val();
            ...
            $(document).on('change', "#paymethod_kdv", function (e) {
                var tur_id = $('#cari_pers_type option:selected').val();
                var paymethod = $('#paymethod_kdv option:selected').val();
                var pay_type = $('#pay_type option:selected').val();
                var customer_id = $('#customer_id').val();


                $(".pay_acc_kdv option").remove();
                $.ajax({
                    type: "POST",
                    url: baseurl + 'search_products/kasalar',
                    data: 'metod=' +paymethod,
                    success: function (datas) {
                        if(datas)
                        {
                            ...
                            jQuery.each(data.kasalar, function (key, item) {
                                $(".pay_acc_kdv").append('<option value="'+ item.id +'">'+item.holder +'</option>');
                            });
            ...
            $("#kdv_durumu").change(function() {

                var invoice_id = $("#cari_in_invoice option:selected").val();
                if(this.checked) {
                    $.ajax({
                        type: "POST",
                        url: baseurl + 'transactions/cari_in_invoice_kdv_total',
                        data:
                        ...
                        success: function (datas) {
                            if(datas)
                            {
                                ...
                                $('#amount_kdv').val(data.kalan);
                                $('#note_kdv').val(data.invoice_no+' '+'Numaralı Qaimeye Esasen KDV Ödenish');
                            }
