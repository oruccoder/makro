                        ...
                        <section class="panel panel-primary box-shadow--16dp">
                            ...
                            <div class="panel-body form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="dosya_no" id="dosya_no" value="<?php echo $invoices->dosya_no ?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="name"><?php echo $this->lang->line('baslama_tarihi') ?></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control required" name="baslama_tarihi" value="<?php echo dateformat($invoices->baslangic_tarihi) ?>" id="baslama_tarihi"
                                               autocomplete="false">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control"  value="<?php echo dateformat($invoices->bitis_tarihi) ?>" name="bitis_tarihi" id="bitis_tarihi"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="name"><?php echo $this->lang->line('Customer') ?></label>
                                    <div class="col-sm-8">
                                        <select class="form-control select2" id="cari_id" name="cari_id">
                                            <option value="0">Cari Seçiniz</option>
                                            <?php
                                            foreach ($customer as $clist) {
                                                if($invoices->cari_id==$clist->id)
                                                {
                                                    ?>
                                                    <option selected value="<?php echo $clist->id ?>"><?php echo $clist->company ?></option>
                                                    <?php
                                                }
                                                else
                                                    {
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" name="description"><?php echo $invoices->description ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="name"><?php echo $this->lang->line('gumrukcu_cari') ?></label>
                                    <div class="col-sm-8">
                                        <select class="form-control select2" id="gumrukcu_firma_id" name="gumrukcu_firma_id">
                                            <option value="0">Cari Seçiniz</option>
                                            <?php
                                            foreach ($customer as $clist) {
                                                if($invoices->gumrukcu_firma_id==$clist->id)
                                                {
                                                    ?>
                                                    <option selected value="<?php echo $clist->id ?>"><?php echo $clist->company ?></option>
                                                    <?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="hidden" value="ihracat/edit_action" id="action-url">
