...
<div class="content-body">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-12">
                    <a class="btn btn-success box-shadow--4dp ripple has-ripple"  href="<?php echo  base_url("ihracat/yeni_dosya") ?>" type="button"><i class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('new_field') ?></a>
                    &nbsp;
                    &nbsp;
                </div>
                <div class="col-md-12">
...
<script>
    ...
    function draw_data(start_date = '', end_date = '',masraf_id='',alt_masraf_id='',odeme_durumu='') {
        $('#invoices').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': "<?php echo site_url('ihracat/ajax_list')?>",
                'type': 'POST',
                'data': {
