...
<head>
    ...
    <title>Üretim Reçetesi #<?php echo $details->invoice_no ?></title>
    <style>
...
<!--            <th>Varyasyon</th>-->
            ...
            <th>Fire Oranı (%)</th>
            <th>Fire Miktarı</th>
            <th>Toplam Tüketilecek Miktar</th>
        </tr>
        </thead>
...
<!--                <td>--><?php //echo invoice_options_html($values->id)?><!--</td>-->
                <td><?php echo amountFormat_s($values->quantity_2) ?></td>
                <td><?php echo units_($values->unit_id)['name'] ?></td>
                <td><?php echo amountFormat_s($values->fire) .'%'; ?></td>
                <td><?php echo amountFormat_s($values->fire_quantity).' '.units_($values->unit_id)['name'] ?></td>
                <td><?php echo amountFormat_s($values->toplam_tuketilen).' '.units_($values->unit_id)['name'] ?></td>
