...
<div class="invoice-box">
    <table  cellpadding="0" cellspacing="0" id="customers" >
        ...
        <tr>
            ...
            <th>Varyasyon</th>
            <th>Miktar</th>
            <th>Birim Fiyatı(EDV'SİZ)</th>
            <th>Toplam Fiyat(EDV'SİZ)</th>
        </tr>
        </thead>
        ...
        foreach ($items as $values) {
            ...
            <tr id="remove<?php echo $values->id?>">
                ...
                <td><?php echo amountFormat_s($values->qty).' '.units_($values->unit)['name'] ?></td>
                <td><?php echo amountFormat_s($values->price)?></td>
                <td><?php echo amountFormat_s($values->subtotal)?></td>
                <td></td>
            </tr>
            <?php $i++; } ?>
