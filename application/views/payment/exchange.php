        ...
        <form method="post" id="data_form" class="form-horizontal">
            <div class="grid_3 grid_4">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row"> <label class="col-sm-4 col-form-label">Secondary Currency as Currency  </label>  <div class="col-sm-8">
                <div class="input-group">
                                            <label class="display-inline-block custom-control custom-radio ml-1">
                                                <input type="radio" name="reverse" class="custom-control-input"
                                        ...
                                        </div><small> Recommended : No | With this option input during bill creation will be considered as per selected currency.  </small>   </div>
