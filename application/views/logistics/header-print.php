...
<table class="mycos" width="100%"  >
    ...
    <tr>
        ...
        <td style="text-align: center; border: 1px solid gray;" rowspan="3"> <h2>Lojistik SATINALMA FORMU</h2></td>
    </tr>
...
<table class="mycooo1" style="font-size: 10px">
    <tr>
        <td>Talep No</td>
        <td><?php echo dateformat($details->created_at).' - '.$details->talep_no ?></td>
    </tr>
    <tr>
        <td>Talep Eden</td>
