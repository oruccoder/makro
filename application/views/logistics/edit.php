<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Lojistik Satınalması Düzenleme</span></h4>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-md-2">
                                                    <input type="hidden" value="<?php echo $details->id ?>" id="talep_id">
                                                    ...
                                                    <select class="form-control select-box lojistik_muduru required" id="lojistik_muduru">
                                                        <?php foreach (personel_list() as $emp){
                                                            ...
                                                            $name=$emp['name'];
                                                            $selected ='';
                                                            if($emp_id==$details->lojistik_muduru){
                                                                $selected = 'selected';
                                                            }
                                                            else {
                                                                $selected ='';
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select class="form-control select-box proje_muduru required" id="proje_muduru">
                                                        <?php foreach (personel_list() as $emp){
                                                            ...
                                                            $name=$emp['name'];
                                                            $selected ='';
                                                            if($emp_id==$details->proje_muduru){
                                                                $selected = 'selected';
                                                            }
                                                            else {
                                                                $selected ='';
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" value="<?php echo $details->description ?>" class="form-control required" name="desc" id="desc">
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control select-box lojistik_talep_id required" multiple id="lojistik_talep_id">
                                                        ...
                                                        <?php foreach (lojistik_talepleri() as $emp){
                                                            ...
                                                            $name=$emp->talep_no;
                                                            $selected ='';
                                                            if(in_array($emp_id,$lojistik_talep)){
                                                                $selected = 'selected';
                                                            }
                                                            else {
                                                                $selected ='';
                                        ...
                                        <div class="col-sm-12" style="overflow-x:auto;">
                                            <table class="table lojistik_table" >
                                                ...
                                                <tr>
                                                    <td>
                                                        <select class="form-control select-box proje_id required" name="proje_id[]">
                                                            <?php foreach (all_projects() as $emp){
                                                                $selected='';
                                                                if($values->proje_id == $emp->id){
                                                                    $selected ='selected';
                                                                }
                                                                ?>
                                                                <option <?php echo $selected ?> value="<?php echo $emp->id; ?>"><?php echo $emp->name; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select class="form-control select-box location required" multiple="multiple" name="location[]">
                                                            <?php foreach (location_name_($values->id) as $emp){
                                                                ?>
                                                                <option selected value="<?php echo $emp->id; ?>"><?php echo $emp->location; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select class="form-control select-box sf_no required" multiple="multiple" name="sf_id[]">
                                                            <?php foreach (lojistik_items_sf_($details->id,$values->id,2) as $emp){
                                                                ?>
                                                                <option selected value="<?php echo $emp->id; ?>"><?php echo $emp->talep_no; ?></option>
                                                            <?php } ?>
                                                    ...
                                                    <td>
                                                        <input type="text" value="<?php echo $values->desc ?>" name="desc[]" class="form-control desc">
                                                    </td>
                                                    <td>
                                                        <select class="form-control select-box personel_id required">
                                                            <?php foreach (personel_list() as $emp){
                                                                ...
                                                                $name=$emp['name'];
                                                                $selected='';
                                                                if(lojistik_items_personel_($details->id,$values->id)==$emp_id){
                                                                    $selected ='selected';
                                                                }
                                                                ?>
                                                                <option  <?php echo $selected ?>  value="<?php echo $emp_id; ?>"><?php echo $name; ?></option>
                                                    ...
                                                    <td>
                                                        <select class="form-control select-box firma_id required" name="firma_id[]">
                                                            <?php foreach (all_customer() as $emp){
                                                                $selected='';
                                                                if($values->firma_id == $emp->id){
                                                                    $selected ='selected';
                                                                }
                                                                ?>
                                                                <option  <?php echo $selected ?>  value="<?php echo $emp->id; ?>"><?php echo $emp->company; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select class="form-control protokol select-box" name="protokol[]">
                                                            <?php foreach (lojistik_items_protokol_($details->id,$values->id,2) as $emp){
                                                                ?>
                                                                <option selected value="<?php echo $emp->id; ?>"><?php echo $emp->code; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input type="number"  value="<?php echo $values->qty ?>" name="qty[]" class="form-control qty">
                                                    </td>
                                                    <td>
                                                        <select class="form-control select-box unit_id required" name="unit_id[]">
                                                            <?php foreach (units() as $emp){
                                                                $selected='';
                                                                if($values->unit_id == $emp['id']){
                                                                    $selected ='selected';
                                                                }
                                                                ?>
                                                                <option <?php echo $selected ?>  value="<?php echo $emp['id']; ?>"><?php echo $emp['name']; ?></option>
                                                    ...
                                                    <td>
                                                        <input type="number" value="<?php echo $values->price ?>"  class="form-control price">
                                                    </td>
                                                    <td>
                                                        <select class="form-control select-box kdv_durum required">
                                                            <?php
                                                            $selected='';
                                                            if($values->kdv_durum == 1){
                                                                $selected ='selected';
                                                            }
                                                            ?>
                                                            <option <?php echo ($values->kdv_durum) ? '': 'selected'; ?> value="0">Hariç</option>
                                                            <option <?php echo ($values->kdv_durum) ? 'selected': ''; ?> value="1">Dahil</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input type="number" value="<?php echo $values->kdv_oran ?>"   class="form-control kdv_oran">
                                                    </td>
                                                    <td>
                                                        <select class="form-control select-box account_type required" name="account_type[]">
                                                            <?php foreach (account_type() as $emp){
                                                                $selected='';
                                                                if($values->account_type == $emp['id']){
                                                                    $selected ='selected';
                                                                }
                                                                ?>
                                                                <option <?php echo $selected ?>  value="<?php echo $emp['id']; ?>"><?php echo $emp['name']; ?></option>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <button type="button" class="btn btn-danger remove btn-sm" title="Sil"><i class="fa fa-minus-square"></i></button>&nbsp
                                                            <button type="button" class="btn btn-warning clone btn-sm" title="Kopyala"
                                                                    proje_id='<?php echo $values->proje_id ?>'
                                                                    proje_name='<?php echo proje_name($values->proje_id) ?>'
                                                                    location='<?php echo $values->location ?>'
                                                                    desc='<?php echo $values->desc ?>'
                                                                    qty='<?php echo $values->qty ?>'
                                                                    unit_id='<?php echo $values->unit_id ?>'
                                                                    unit_name='<?php echo units_($values->unit_id)["name"] ?>'
                                                                    arac_id='<?php echo $values->arac_id ?>'
                                                                    arac_name='<?php echo arac_view($values->arac_id)->name ?>'
                                                                    options_loc='<?php foreach (location_name_($values->id) as $emp)
                                                                    {

                                                                        echo '<option selected value="'.$emp->id.'">'.$emp->location.'</option>';
                                                                    }
                                                                    ?>'
                                                                    options_sf='   <?php foreach (lojistik_items_sf_($details->id,$values->id,2) as $emp){

                                                                echo '<option selected value="'.$emp->id.'">'.$emp->talep_no.'</option>'; } ?>'
                                        ...
                                        <div class="col-md-12" style="padding-top: 14px;">
                                            <button type="button" class="btn btn-info sub-btn btn-lg" id="talep_create">Talep Güncelle</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script>
    ...
    $(document).on('click', "#talep_create", function (e) {
        $.confirm({
            theme: 'material',
            closeIcon: true,
            title: 'Lojistik Talebi Güncelle',
            ...
            draggable: false,
            content: 'Lojistik Talebi Güncellemek Üzeresiniz Emin Misiniz?',
            buttons: {
                formSubmit: {
                    text: 'Talep Oluştur',
                    btnClass: 'btn-blue',
                    action: function () {
                        ...
                        $.post(baseurl + 'logistics/update_save',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
