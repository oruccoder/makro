...
<footer style="padding-bottom: 50px">
    ...
    <table  style="font-size: 12px">
        ...
        <tr>
            ...
            <th><?php echo personel_details($details->lojistik_muduru) ?><?php echo lojistiksf_durum_kontrol($details->lojistik_muduru,$details->id) ?></th>
            <th><?php echo personel_details($details->proje_muduru) ?><?php echo lojistiksf_durum_kontrol($details->proje_muduru,$details->id) ?></th>
            <th><?php echo personel_details($details->genel_mudur) ?><?php echo lojistiksf_durum_kontrol($details->genel_mudur,$details->id) ?></th>
        </tr>
