                        ...
                        <div class="col-lg-12">
                            ...
                            <span
                                ...
                                <a href="#cancel-bill" class="btn btn-danger mb-1" id="cancel-bill"><i
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                           href="<?php echo 'delivery?id=' . $invoice['id']; ?>"><?php echo $this->lang->line('Delivery Note') ?></a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                           href="<?php echo 'proforma?id=' . $invoice['id']; ?>"><?php echo $this->lang->line('Proforma Invoice') ?></a>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item"
                                           href="<?php echo base_url().'pos_invoices/thermal_pdf?id=' . $invoice['id']; ?>"><?php echo $this->lang->line('PDF Print') ?></a>
                    ...
                    <div class="row">
                        <table class="table table-striped">
                            ...
                            <?php foreach ($attach as $row) {
                                ...
                                echo '<tr><td><a data-url="' . base_url() . 'invoices/file_handling?op=delete&name=' . $row['col1'] . '&invoice=' . $invoice['id'] . '" class="aj_delete"><i class="btn-danger btn-lg icon-trash-a"></i></a> <a class="n_item" href="' . base_url() . 'userfiles/attach/' . $row['col1'] . '"> ' . $row['col1'] . ' </a></td></tr>';
                            } ?>
