<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Maaş Talebi Görüntüle</span></h4>
                                                        ...
                                                        <div class="col col-xs-12 col-sm-12 col-md-12 no-padding">
                                                            <div class="table-responsive">
                                                                <table class="table table-responsive">
                                                                    ...
                                                                    <tr>
                                                                        <td class="vert-align-mid" ><span class=" txt-color-darken no-padding">Avans Talebi Personeli: </span></td>
...
//                                                                            if(floatval($tutar) < floatval($values->total)){
//                                                                                $style='style="
//                                                                                text-align: center;
...
<!--                                                                --><?php
//                                                                if(talep_onay_new(3,$details->id)){ //   if(talep_onay_new(3,$details->id)){
