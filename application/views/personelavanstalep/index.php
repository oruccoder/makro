         ...
         <label for="resim">Fayl</label>
           <div id="progress" class="progress">
            ...
            <input type="hidden" class="image_text" name="image_text" id="image_text">
                                ...
                                buttons: {
                                    formSubmit: {
                                        ...
                                        action: function () {
                                            ...
                                            $.post(baseurl + 'personelavanstalep/create_save',data,(response) => {
                    ...
                    {
                        text: '<i class="fa fa-plus"></i>Başka Personel İçin Yeni Avans Talebi Oluştur',
                        action: function ( e, dt, node, config ) {
                            $.confirm({
                                theme: 'modern',
                                closeIcon: true,
...
<div class="form-row">
    <div class="form-group col-md-6">
      ...
      <textarea class="form-control" id="desc"></textarea>
       ...
       <div class="form-group col-md-6">
      <label for="marka">Personel</label>
     <select class="form-control cach_personel select-box">
                <option value="0">Avans Talep Ettiğiniz Personel</option>
                                ...
                                buttons: {
                                    formSubmit: {
                                        ...
                                        action: function () {
                                            ...
                                            let cach_personel=$('.cach_personel').val();
                                            if(!cach_personel){
                                                $.alert({
                                                    theme: 'material',
                                                    icon: 'fa fa-exclamation',
                                            ...
                                            $.post(baseurl + 'personelavanstalep/create_save_yetki',data,(response) => {
                                                let responses = jQuery.parseJSON(response);
                                                $('#loading-box').addClass('d-none');
                                                if(responses.status=='Success'){
                                                    $.alert({
