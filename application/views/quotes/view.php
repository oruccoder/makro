                    ...
                    <div class="row wrapper white-bg page-heading">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="title-action">
                                ...
                                <a style="display: none" href="#pop_model2" data-toggle="modal" data-remote="false"
                            ...
                            <span
                                ...
                                <a style="display: none" href="<?php echo $link; ?>" class="btn btn-primary mb-1"><i
            ...
            dataType: 'json',
             formData: {'<?=$this->security->get_csrf_token_name()?>': crsf_hash},
                ...
                $.each(data.result.files, function (index, file) {
                    $('#files').append('<tr><td><a data-url="<?php echo base_url() ?>quote/file_handling?op=delete&name=' + file.name + '&invoice=<?php echo $invoice['iid'] ?>" class="aj_delete"><i class="btn-danger btn-sm icon-trash-a"></i> ' + file.name + ' </a></td></tr>');
