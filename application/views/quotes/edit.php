    ...
    <div class="card-content">
        ...
        <form method="post" id="data_form">
            <div class="row">
                    ...
                    <div id="customerpanel" class="inner-cmp-pnl">
                        <div class="form-group row">
                            <div class="fcol-sm-12">
                                <h3 class="title">
                                    ...
                                    <a href='#'  class="btn btn-success  btn-sm " data-toggle="modal" class="a_href" data-target="#addCustomer" title="Cari Ekle"> <i class="fa fa-plus-circle fa-lg"></i>
                                    </a>
                                </h3>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="frmSearch col-sm-12"><label for="cst" class="caption">Cari Bul</label>
                        ...
                        <div id="customer">
                            ...
                            <div class="clientinfo">
                                ...
                                <hr>
                                <div id="customer_pass"></div><div class="col-md-6">
                                    <?php echo $this->lang->line('Warehouse') ?>
                                    <input type="hidden"  name="warehouses" value="<?php echo $invoice['warehouses'] ?>">
                                    <input class="form-control round" type="text"  disabled value="<?php echo depo_name($invoice['warehouses']) ?>">



                                    <select readonly="false" id="warehouses"  style="visibility: hidden" class="selectpicker form-control round">

                                        <?php foreach ($warehouse as $row) {

                                            $cid = $row['id'];
                                            $title = $row['title'];
                                            if($invoice['warehouses']==$cid)
                                            {
                        ...
                        <div class="inner-cmp-pnl">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12"><h3 class="title">Teklif Detayları</h3></div>

                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6"><label for="invocieno" class="caption">Teklif No</label>
                                ...
                                <div class="col-sm-6"><label for="invocieno" class="caption">Referans</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6"><label for="invociedate" class="caption">Tarih</label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control required editdate"
                                               ...
                                               value="<?php echo dateformat($invoice['invoicedate']) ?>">  <input type="hidden" name="iid"
                                               value="<?php echo $invoice['iid']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6"><label for="invocieduedate" class="caption">Geçerlilik Tarihi</label>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="toAddInfo" class="caption"><?php echo $this->lang->line('Proposal Message') ?></label>
                        <textarea class="summernote" name="propos" id="contents"
                                  rows="2"><?php echo $invoice['proposal'] ?></textarea></div>
                    <div class="col-sm-6">
                        <label for="toAddInfo" class="caption"><?php echo $this->lang->line('quo_teslimat') ?></label>
                        <textarea class="summernote" name="teslimat" id="contents"
                                  rows="2"><?php echo $invoice['teslimat'] ?></textarea></div>
                </div>
...
<button type="button" data-rowid="' . $i . '" class="btn btn-danger removeProd" title="Remove"> <i class="icon-minus-square"></i> </button>
                    ...
                    ';
                        ...
                        <tr class="last-item-row sub_c">
                            <td class="add-row">
                                <button type="button" class="btn btn-success" aria-label="Left Align"
                                        data-toggle="tooltip"
                                        data-placement="top"  id="addproduct">
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            <td class="" colspan="2"><?php echo $this->lang->line('Payment Terms') ?>
