<div class="content-body">
    <div class="card">
     ...
     <?php echo $this->lang->line('Bill To') ?> <a href='#'
                                                   ...
                                                   data-toggle="modal"
                                                   data-target="#addCustomer"><i class="fa fa-plus-circle fa-lg"></i>
                                            </a>
                                ...
                                <div class="form-group row">
                                    <div class="frmSearch col-sm-12"><label for="cst"
                                        ...
                                        <input type="text" class="form-control" name="cst" id="customer-box"
                                               placeholder="Müşteri Adı veya Gsm Numarasını Giriniz"
                                               autocomplete="off"/>
                                ...
                                <div id="customer">
                                    ...
                                    <select id="warehouses" name="warehouses" class="selectpicker form-control round">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="notes" rows="2">Fiyatlarımızda KDV Dahil Değildir.</textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <textarea class="summernote" name="propos" id="contents" rows="2">Onay Sonrası 15 Gün Üretim / 10 Gün Nakliye</textarea></div>
                        <div class="col-sm-6">
                            <label for="toAddInfo"
                                   class="caption"><?php echo $this->lang->line('quo_teslimat') ?></label>
                            <textarea class="summernote" name="teslimat" id="contents" rows="2">Bakü Proje Noktası Teslim</textarea></div>
                    </div>
                        ...
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="currenty"><?php echo $this->config->item('currency'); ?></span></td>
