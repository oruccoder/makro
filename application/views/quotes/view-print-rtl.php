...
<table dir="rtl">
    ...
    <table class="plist" cellpadding="0" cellspacing="0">
        ...
        foreach ($products as $row) {
            ...
            if ($invoice['tax'] > 0) { $cols++; echo '<td style="width:16%;">' . amountExchange($row['totaltax'],$invoice['multi'],$invoice['loc']) . ' <span class="tax">(' . amountExchange($row['tax'],$invoice['multi']) . '%)</span></td>'; }
