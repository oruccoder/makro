                        ...
                        <div class="col-6">
                            ...
                            <div class="table-responsive">
                                ...
                                <span data-popup="popover" title="Proje Adı" data-trigger="hover" data-content="<?php echo proje_name($details->proje_id)?>">
                                    ...
                                    <tr>
                                        <th style="text-align: center" colspan="4"><button type="button" class="btn btn-info satinalma_atama"><i class="fa fa-users"></i> Seçili Ürünlere Personel Ata</button></th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <?php foreach (talep_onay_listesi($details->id, 4)['onay_listesi'] as $onay_user):
