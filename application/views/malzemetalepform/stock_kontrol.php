                        ...
                        <div class="col-6 col-xs-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <?php foreach (talep_onay_listesi($details->id, 2)['onay_listesi'] as $onay_user):
                                    ...
                                    <?php foreach ($talep_products as $key => $items): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                echo ($details->status == 2) ? $input : $text;
                                                ?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                // Buton HTML'si
                                                $add_button = '<button type="button" class="btn btn-outline-danger form_remove_products_basvuru" item_id="'.htmlspecialchars($items['id']).'" style="margin: 20px;">
                                                      <i class="fa fa-trash"></i>
                                                   </button>';

                                                echo ($details->status == 2) ? $add_button : '-';
