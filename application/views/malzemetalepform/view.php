        ...
        <div class="card-body">
            <div class="col col-xs-12 col-sm-12 col-md-12">
                <div class="container-fluid">
                            ...
                            <div class="table-responsive">
                                ...
                                <span data-popup="popover" title="Proje Adı" data-trigger="hover" data-content="<?php echo proje_name($details->proje_id)?>">
                                    ...
                                    <tr>
                                        ...
                                        <td><a target="_blank" href="/personel/view/<?=$details->aauth?>"><b><?php echo personel_details($details->aauth)?></b></a></td>
                                    </tr>
                                    <tr>
                                        <th>Açıklama :</th>
                                        <td><?php echo $details->desc?></td>
                                        <th>Talep Eden :</th>
                                        <td><a target="_blank" href="/personel/view/<?=$details->talep_eden_user_id?>"><b><?php echo personel_details($details->talep_eden_user_id)?></b></a></td>
                                    </tr>
                                    <tr>
                                        <th colspan="2">Proje Deposu</th>
                                        <td colspan="2"><b><a target="_blank" href="/warehouse/view/<?=$details->warehouse_id?>"><?php echo warehouse_details($details->warehouse_id)->title ?></b></a></td>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4 class="border-bottom pb-2 pt-2"><b>Başvuru Sürecindeki Ürünleri</b></h4>
                            <div class="table-responsive">
                                        ...
                                        <?php foreach ($talep_products as $key => $items): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    // Giriş alanı
                                                    $input = '<input type="text" value="' . htmlspecialchars($items['qty']) . '" class="form-control item_qty" item_id="' . htmlspecialchars($items['id']) . '">';
                                                    // Formatlanmış metin
                                                    $text = amountFormat_s($items['qty']);
                                                    // Duruma göre giriş alanı veya metin gösterimi
                                                    echo ($details->status == 1) ? $input : $text;
                                                    ?>
                                                             </td>
                                                ...
                                                <td>
                                                    <?php
                                                    // Buton HTML'si
                                                    $add_button = '<button type="button" class="btn btn-outline-danger form_remove_products" item_id="'.htmlspecialchars($items['id']).'" style="margin: 20px;">
                                                      <i class="fa fa-trash"></i>
                                                   </button>';

                                                    echo ($details->status == 1) ? $add_button : '-';
                                                    // Koşula göre buton göster
                                                    ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                ...
                                <div class="text-center">
                                    <?php
                                    // Buton HTML'si
                                    $add_button = '<button type="button" class="btn btn-primary add_product" style="margin: 20px;">
                      <i class="fa fa-plus"></i> Tələb etmək üçün material təyin edin
                   </button>';
                                    // Duruma göre butonu göster
                                    echo ($details->status == 1) ? $add_button : '';
                                    ?>
                                </div>
                            </div>
...
<script>
    ...
    $(document).on('click', '.form_add_products', function () {
        ...
        // POST isteği gönder
        $.post(baseurl + 'malzemetalepform/create_form_items', data, (response) => {
                        ...
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                <td><img style="max-width:40%" height="auto" class="img-fluid" src="${responses.data.image}"></td>
                                 ...
                                 <td>${responses.data.product_status}</td>
                                <td>
    ...
    $(document).on('click','.bildirim_baslat',function (){
        $.confirm({
            theme: 'modern',
            closeIcon: false,
            title: 'Stok Kontrol Bildirimi',
            icon: 'fa fa-bell',
            type: 'green',
            animation: 'scale',
            useBootstrap: true,
            ...
            smoothContent: true,
            draggable: false,
            content: "Stok Kontrol Onayına Sunmak İstediğinizden Emin Misiniz?",
            buttons: {
                formSubmit: {
                    text:'Onaya Sun',
                    btnClass:'btn btn-info btn-sm',
                    action:function (){
                        // AJAX ile sunucuya gönder
                        $.ajax({
                            url: baseurl + 'malzemetalepform/stok_kontrol_onayi', // Sunucuya gönderilecek endpoint
                            type: 'POST',
                            dataType: 'json',
                            data: {
                                talep_id: $('#talep_id').val(),
