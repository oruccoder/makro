<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Malzeme Talebi</span></h4>
                                                        ...
                                                        <div class="jarviswidget mb-3">
                                                            <div class="borderedccc no-padding">
                                                                <div class="widget-body" style="padding: 15px;">
                                                                    <a href="/malzemetalep" class="btn btn-secondary" data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="İstek Siyahısı"><i class="fa fa-arrow-left"></i></a>
                                                                    ...
                                                                    <button type="button" class="btn btn-secondary transfer_status_change_new" transfer_status="<?php echo $details->transfer_status?>" talep_id="<?php echo $details->id ?>" data-original-title="Bilgilendirme"  data-popup="popover" data-trigger="hover" data-placement="top" data-content="Transfer Durumunu Değiştir"><i class="fa fa-warehouse"></i></button>
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table table-responsive">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="vert-align-mid " ><div class="dgt_isPlaces"><span class="font-sm txt-color-darken no-padding">Teslimat Yeri: </span></div>
                                                                                        <?php
                                                                                        $transfer_status='';
                                                                                        if($details->status==7){
                                                                                    ...
                                                                                    <td class="vert-align-mid">
                                                                                        <label class="font-md-2 txt-color-darken no-padding dgt_isPlaces no-margin">
                                                                                            <?php if(!$details->warehouse_id) {
                                                                                                ?>
                                                                                                <button class="btn btn-danger warehouse_create" tip="1"><i class="fa fa-warehouse"></i>&nbsp;Çatdırılma Yeri</button><?php echo $transfer_status?>
                                                                                                <?php
                                                                                            }
                                                                                            else {
                                                                                                ?>
                                                                                                <div class="dgt_isPlaces">
                                                                                                    <button class="btn btn-success warehouse_create" tip="1"><i class="fa fa-warehouse"></i>&nbsp;<?php echo  warehouse_details($details->warehouse_id)->title ?></button><?php echo $transfer_status?>
                                                                                                    <br>
                                                    ...
                                                    <div class="col col-md-12 col-xs-12">
                                                        <div class="jarviswidget" id="wid-id-7">
                                                            ...
                                                            if($details->status==1 || $details->status==17) { ?>
                                                                <div class="borderedccc no-padding">
                                                                    <?php if($items){  //varsa ?>
                                                                        <a href="/malzemetalep/talep_list_print/<?php echo $details->id; ?>" class="btn btn-warning" title="Talep Listesi">Talep PDF Çıxış</a>
                                                                        ...
                                                                        <table class="table ">
                                                                            ...
                                                                            foreach ($items as $values) {
                                                                                ...
                                                                                <tr  id="remove<?php echo $values->id?>">
                                                                                    <td><?php echo $i ?></td>
                                                                                    <td><img style="width: 120px;" class="image_talep_product parent_image_replace" product_stock_code_id='<?php echo $values->product_stock_code_id?>' src="<?php echo base_url().$image ?>"></td>
                                                                    ...
                                                                    if($details->status==17 || $this->aauth->get_user()->id==741 || $this->aauth->get_user()->id==1147){
                                                                        $disable_add_button='';
                                                                    }
                                                                    else{
...
//                                                                    }
                                                                    ?>
                                                                    <div class="text-center">
                                                                        <button <?php echo $disable_add_button;?> type="button" talep_type="<?php echo $details->talep_type?>" demirbas_id="<?php echo $details->demirbas_id?>" firma_demirbas_id="<?php echo $details->firma_demirbas_id ?>" class="btn btn-primary add_product" style="margin: 20px;"><i class="fa fa-plus"></i> Tələb etmək üçün material təyin edin</button>
                                                                    </div>
                                                            ...
                                                            <div class="tab-content px-1 pt-1">
                                                                            ...
                                                                            <?php if(move_product($details->id)) {
                                                                                ...
                                                                                foreach (move_product($details->id) as $move_product_items){
                                                                                    ...
                                                                                    <tr style="color: #c1c1c1;">
                                                                                        ...
                                                                                        <td><a href="/malzemetalep/view/<?php echo $move_product_items->form_id;?>" target="_blank" class="btn btn-outline-success">MT Görüntüle</a> </td>
                                                                ...
                                                                <a target="_blank" class="btn btn-sm btn-info teklif_visable" style="'.$display .'" cari_id="'.$cari_id.'" href="/malzemetalep/teklif_update_view?cari_id='.$cari_id.'&form_id='.$details->id.'"><i class="fa fa-edit"></i></a>
                                                                <a href="/malzemetalep/teklif_print?cari_id='.$cari_id.'&form_id='.$details->id.'" style="'.$display .'" class="btn btn-sm btn-warning teklif_visable" title="PDF Çıxış"><i class="fa fa-file-pdf"></i></a>
                                                            </div>
                                                                ...
                                                                ';
                                                                                                            ...
                                                                                                            echo '<div style="padding-bottom: 15px;">
                                                                <a target="_blank" class="btn btn-sm btn-info teklif_visable" cari_id="'.$cari_id.'" style="'.$display .'"  href="/malzemetalep/teklif_update_view?cari_id='.$cari_id.'&form_id='.$details->id.'"><i class="fa fa-edit"></i></a>
                                                                    <a href="/malzemetalep/teklif_print?cari_id='.$cari_id.'&form_id='.$details->id.'" class="btn btn-sm btn-warning teklif_visable" style="'.$display .'" title="PDF Çıxış"><i class="fa fa-file-pdf"></i></a>
                                                            </div>
                                                                ...
                                                                ';
                                                                                        ...
                                                                                        elseif($details->talep_type==3){
                                                                                            ...
                                                                                            echo '<div style="padding-bottom: 15px;">
                                                                <a target="_blank" class="btn btn-sm btn-info"  cari_id="'.$cari_id.'" href="/malzemetalep/teklif_update_view?cari_id='.$cari_id.'&form_id='.$details->id.'"><i class="fa fa-edit"></i></a>
                                                                <a href="/malzemetalep/teklif_print?cari_id='.$cari_id.'&form_id='.$details->id.'" class="btn btn-sm btn-warning teklif_visable" title="PDF Çıxış"><i class="fa fa-file-pdf"></i></a>
                                                            </div>
...
//                                                                                }
                                                                    ...
                                                                    <div class="col-md-12 pt-4 pb-2">
                                                                        <table class="table">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <!--td><a href="/malzemetalep/teklif_incele/<?php echo $details->id?>" class="btn btn-info"><i class="fa fa-eye"></i>&nbsp; İncele</a></td-->
                                                                ...
                                                                <div class="tab-pane fade <?php  if($details->status==5){ echo "active show"; } ?>" id="siparis" role="tabpanel" aria-labelledby="link-tab" aria-expanded="false">
                                                                    ...
                                                                    ?>
                                                                    <div class="pb-2">
                                                                        <a href="/malzemetalep/siparis_print/<?php echo $details->id; ?>" class="btn btn-warning" title="Sifaris PDF Çıxış">Sifariş PDF Çıxış</a>
                                                                    </div>
                                                                    <div class="col-md-12 pt-4 pb-2" style="overflow: auto;">
                                                                        <table class="table">
                                                                            ...
                                                                            if($siparis_list_kontrol) {
                                                                                ...
                                                                                foreach ($siparis_list_kontrol as $urunler){
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <th>
                                                                                            <?php
                                                                                            $talep_form_product_id = talep_form_item_id($onay_list_id_sorgu);
                                                                                            if($details->talep_type==1){
                                                                                            echo product_details_($urunler->product_id)->product_name.'<br>'.talep_form_product_options_teklif_html($talep_form_product_id);?></th>
                                                                                        ...
                                                                                        if($details->id < 3193){
                                                                                            echo cost_details($urunler->product_id)->name;
                                                                                        }
                                                                                        else {
                                                                            ...
                                                                            if($urunler['type']==1){ //firmadır
                                                                                ...
                                                                                $qty=amountFormat_s($talep_form_teklifler_item_details->qty);
                                                                                $qtys=$talep_form_teklifler_item_details->qty;
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th>
                                                                                    <?php
                                                                                    if($details->talep_type==1){
                                                                                        echo product_details_($pid)->product_name.'<br>'.talep_form_product_options_teklif_html($urunler['talep_form_product_id']);;
                                                                                    }
                                                                                    elseif($details->talep_type==2){
                                                                                        echo product_details_($pid)->product_name.'<br>'.talep_form_product_options_teklif_html($urunler['talep_form_product_id']);;
                                                                                    }
                                                                                ...
                                                                                <td><?php echo "<input style='width: 125px;' type='number' eq='$eq'  value='$qtys' class='form-control new_item_qty'>" ?></td>
                                                            ...
                                                            <div class="col-md-12 pt-4 pb-2" style="overflow: auto;">
                                                                <hr>
                                                                <h3 style="text-align: center">Çatdırılma Bilgisi</h3>
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                    <?php foreach (array_unique($cari_array) as $cari_uniq){ ?>
                                                                        <tr>
                                                                            <th><?php echo customer_details($cari_uniq)['company']?></th>
                                                                            <th><?php echo amountFormat(cari_teklif_nakliye_kontrol($cari_uniq,$details->id))?></th>
                                                                        </tr>
                                                                    <?php } ?>
                                                                    </tbody>
                                                                </table>
...
<!--                                                                            <button tip="0" class="btn btn-danger siparis_onay_iptal_finish"><i class="fa fa-ban"></i> Satınalmayı Durdur Formu İptal Et</button>-->
                                                        ...
                                                        <div class="tab-pane fade <?php  if($details->status==11 || $details->status==18 || $details->status==19 || $details->status==20 || $details->status==12){ echo "active show"; } ?>" id="on_odeme" role="tabpanel" aria-labelledby="link-tab" aria-expanded="false">
                                                            <div class="col-md-12 pt-4 pb-2">
                                                                <?php
                                                                $teklif_avans_kontrol = teklif_avans_kontrol($details->id);
                                                                if($teklif_avans_kontrol){
                                                                    ?>
                                                                    <table class="table">
                                                                        <thead>
                                                                        <tr>
                                                                            <td><input type="checkbox" class="all_on_odeme_check" style="margin-left: 19px;"></td>
                                                                            <th>Firma</th>
                                                                            <th>Avans Tutarı</th>
                                                                            <th>Toplam Tutar (EDVSIZ) + Çatdırılma</th>
                                                                            <th>Ödeme Metodu</th>
                                                                            <th>Durum</th>
                                                                            <th>İşlem</th>
                                                                        ...
                                                                        $kontrol_avans=[];
                                                                        $kontrol_odeme=[];
                                                                        $kontrol_avans_status=[];
                                                                        $islem='Yetkiniz Yoktur';

                                                                        foreach($teklif_avans_kontrol as $avas_items){
                                                                            $details_avans = teklif_avans_details($avas_items);
                                                                            $cari_id = $details_avans['cari_id'];
                                                                            $kontrol_avans[]=avans_odeme_kontrol($details->id,1,$cari_id);
                                                                            $kontrol_odeme[]=avans_odeme_kontrol($details->id,2,$cari_id);
                                                                            $firma_name = $details_avans['firma_name'];
                                                                            $method = $details_avans['method'];
                                                                            $alt_total_val = $details_avans['alt_total_val'];
                                                                            $talep_form_teklifler_id = $details_avans['talep_form_teklifler_id'];
                                                                            $talep_form_teklifler_details_id = $details_avans['talep_form_teklifler_details_id'];
                                                                            $avans_tutari = $details_avans['avans_tutari'];
                                                                            $toplam_tutar = $details_avans['toplam_tutar'];
                                                                            $para_birimi = $details_avans['para_birimi'];
                                                                            $method_id = $details_avans['method_id'];
                                                                            $para_birimi_name = $details_avans['para_birimi_name'];
                                                                            $durum='';
                                                                            $status=0;
                                                                            $avans_price =    "<button class='btn btn-success avans_price_update'   alt_total_val='".$toplam_tutar."'  cari_id = '".$cari_id."' avans_tutar='".$avans_tutari."'  talep_form_teklifler_details_id='".$details_avans['talep_form_teklifler_details_id']."' avans_update'><i class='fa fa-bank'></i>&nbsp;".$details_avans['avans_price']."</button>";

                                                                            if(avans_odeme_kontrol_details($details->id,1,$cari_id)){

                                                                                if(avans_odeme_kontrol_details($details->id,2,$cari_id))
                                                                                {

                                                                                    $islem='';

                                                                                    $status = avans_odeme_kontrol_details($details->id,2,$cari_id)->status_id;
                                                                                    $talep_form_avans_id = avans_odeme_kontrol_details($details->id,2,$cari_id)->id;
                                                                                    $sort_details = talep_form_sort_why($talep_form_avans_id);
                                                                                    $name='';
                                                                                    if($sort_details){
                                                                                        $name=' | '.$sort_details->name;
                                                                                    }
                                                                                    $durum  = talep_form_avans_status($status)->name.$name;
                                                                                    if($sort_details){
                                                                                        if($sort_details->staff_id ==$this->aauth->get_user()->id){


                                                                                            if($status!=6){
                                                                                                $islem ='<button class="btn btn-success btn-sm odeme_onayla" cari_id="'.$cari_id.'" talep_form_avans_id="'.$talep_form_avans_id.'" tip="1"><i class="fa fa-check"></i></button>&nbsp;<button talep_form_avans_id="'.$talep_form_avans_id.'"  class="btn btn-danger btn-sm odeme_onayla" tip="2"><i class="fa fa-ban"></i></button>';
                                                                                            }
                                                                                        }
                                                                                    ...
                                                                                    $islem='';
                                                                                    $status = avans_odeme_kontrol_details($details->id,1,$cari_id)->status_id;

                                                                                    $talep_form_avans_id = avans_odeme_kontrol_details($details->id,1,$cari_id)->id;
                                                                                    $sort_details = talep_form_sort_why($talep_form_avans_id);
                                                                                    ...
                                                                                    if($sort_details){
                                                                                        if($sort_details->staff_id==$this->aauth->get_user()->id){
                                                                                            ...
                                                                                            if($status!=6){
                                                                                                $islem ='<button class="btn btn-success btn-sm avans_onayla" cari_id="'.$cari_id.'" talep_form_avans_id="'.$talep_form_avans_id.'" tip="1"><i class="fa fa-check"></i></button>&nbsp;<button talep_form_avans_id="'.$talep_form_avans_id.'"  class="btn btn-danger btn-sm avans_onayla" tip="2"><i class="fa fa-ban"></i></button>';
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
                                                                            ...
                                                                            if(avans_odeme_kontrol_details($details->id,2,$cari_id)){
                                                                                $why_id = avans_odeme_kontrol_details($details->id,2,$cari_id)->id;
                                                                                $odeme_kontrol = talep_odeme_emri_kontrol($why_id);
                                                                                if($odeme_kontrol){
                                                                                    if($status==4){
                                                                                        $islem ='<button class="btn btn-success btn-sm odeme_yap"
                                                                         cari_name="'.customer_details($cari_id)['company'].'" 
                                                                         proje_code="'.proje_code($details->proje_id).'" 
                                                                         proje_id="'.$details->proje_id.'" 
                                                                         method_id="'.$method_id.'" 
                                                                         method_name="'.$method.'" 
                                                                         para_birimi_name="'.$para_birimi_name.'" 
                                                                         total="'.$avans_tutari.'" 
                                                                         para_birimi_id="'.$para_birimi.'" 
                                                                         talep_code="'.$details->code.'" 
                                                                         cari_id="'.$cari_id.'" talep_form_avans_id="'.$why_id.'" tip="1"><i class="fa fa-bank"></i>&nbsp; Ödeme Yap</button>';
                                                                                    }
                                                                                    else {
                                                                                        $islem='';
                                                                                    }
                                                                            ...
                                                                            if(avans_odeme_kontrol($details->id,1,$cari_id)){
                                                                                $check='';
                                                                                if($status==2) //Avans Onaylandıysa
                                                                                {
                                                                                    $kontrol_avans_status[]=$status;
                                                                                    $check= '<label class="checkbox">
                                                <input type="checkbox"  class="one_on_odeme_check" eq="'.$eq.'" 
                                                talep_form_teklifler_details_id="'.$talep_form_teklifler_details_id.'"
                                                talep_form_teklifler_id="'.$talep_form_teklifler_id.'"
                                                cari_id="'.$cari_id.'"
                                                ...
                                                method_id="'.$method_id.'"
                                                    ...
                                                    ><i style="top: 12px;"></i>
                                                                            ...
                                                                            $odeme_yapacak_personel='';
                                                                            $odem_btn='';
                                                                            $avans_id_details=avans_odeme_kontrol_details($details->id,2,$cari_id);
                                                                            if($avans_id_details){

                                                                                $sort_details = talep_form_muhasebe($avans_id_details->id);
                                                                                if($sort_details){
                                                                                    $odeme_yapacak_personel=$sort_details->name;
                                                                                    $staff_id = $sort_details->muhasebe_id;
                                                                                    $odem_btn="<button type='button' staff_id='$staff_id'  sort_avans_id='$sort_details->talep_form_avans_id' id='pay_set_update' class='btn btn-success'><i class='fa fa-user-alt'></i>$odeme_yapacak_personel</button>";
                                                                                    if($method_id==3){
                                                                                        $odem_btn.=" <button type='button' cari_id='$cari_id'  id='cari_hesap_faktura_add' class='btn btn-success' data-original-title='Bilgilendirme'  data-popup='popover' data-trigger='hover' data-placement='top' data-content='Cariden Hesap faktura iste'><i class='fa fa-mail-bulk'></i></button>";
                                                                ...
                                                                <?php
                                                                if($details->status==11 || $details->status==18 || $details->status==19 || $details->status==20 || $details->status==12) {
                                                                    ?>
                                                                    <div class="col-md-12 pt-4 pb-2">
                                                                        <?php if(in_array(0,$kontrol_avans)){ ?>
                                                                            <button class="btn btn-success avans_talep_et"><i class="fa fa-check"></i> Avans Talebi Oluştur</button>
                                                                        <?php }
                                                                        if(in_array(2,$kontrol_avans_status)){ ?>
                                                                            <button class="btn btn-success odeme_talep_et"><i class="fa fa-check"></i> Ödeme Talebi Oluştur</button>
                                                                        <?php } ?>
                                                                        <button class="btn btn-info sened_asama_update" style="float: right;padding: 5px;"><i class="fa fa-file"></i> Senedler Aşamasına Geçiş Yap</button>
                                                                    </div>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
...
<!--                                                            --><?php // if($details->status==6) { ?>
                                                                <div class="col-md-12 pt-4 pb-2">
                                                                    ...
                                                                    <button class="btn btn-success anbar_asama"><i class="fa fa-check"></i> Anbar Aşamasına Geçiş Yap</button>
                                                                </div>
<!--                                                            --><?php //} ?>
                                                        ...
                                                        <div class="tab-pane fade <?php  if($details->status==7){ echo "active show"; } ?>" id="teslimat" role="tabpanel" aria-labelledby="link-tab" aria-expanded="false">
                                                            ...
                                                            <div class="pb-2">
                                                                <button id="tehvil_print" class="btn btn-warning" title="Tehvil PDF Çıxış">Seçili Olanları PDF Çıxış</button>
                                                            </div>
                                                            <div class="col-md-12 pt-4 pb-2">
                                                                <table class="table">
                                                                    <thead>
                                                                    ...
                                                                    if(tehvil_products($details->id)){
                                                                        foreach (tehvil_products($details->id) as $product_items){
                                                                            ...
                                                                            <tr>
                                                                                <td><label class="checkbox">
                                                                                        <input type="checkbox"  class="one_tehvil_products" eq="<?php echo $eq ?>" teslimat_warehouse_id="<?php echo $product_items->id ?>" product_id="<?php echo $product_items->product_id?>"><i style="top: 12px;"></i>
                                                                                    </label>
                                                                                </td>
                                                                                ...
                                                                                <td><?php
                                                                                    ...
                                                                                    if($details->talep_type==1){
                                                                                        echo product_details_($product_items->product_id)->product_name.'<br>'.talep_form_product_options_teklif_html($product_items->talep_form_product_id);
                                                                                    }
                                                                                    elseif($details->talep_type==2){
                                                                                        echo product_details_($product_items->product_id)->product_name.'<br>'.talep_form_product_options_teklif_html($product_items->talep_form_product_id);
                                                                                    ...
                                                                                    elseif($details->talep_type==3){
                                                                                        if($details->id < 3193){
                                                                                            echo cost_details($product_items->product_id)->name;
                                                                                        }
                                                                                        else {
...
//                                                                                $image=product_full_details_parent($product_items->product_stock_code_id,$product_items->product_id)['image']
                                                                                ...
                                                                                <td><input type="number" value="<?php echo $kalan_miktar?>" class="form-control warehouse_item_qty" max="<?php echo $kalan_miktar ?>" onkeyup="amount_max(this)"></td>
                                                                                <td><input type="text" class="form-control warehouse_item_notes"></td>
                                                                            </tr>
                                                                            <?php
                                                                            $eq++;
                                                                        }
                                                                            ...
                                                                            foreach (warehouse_teslimat_transfer($details->id) as $product_items) {
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?php
                                                                                        ...
                                                                                        if($details->talep_type==1){
                                                                                            echo product_details_($product_items->product_id)->product_name ;
                                                                                        }
                                                                                        elseif($details->talep_type==2){
                                                                                            echo product_details_($product_items->product_id)->product_name ;
                                                                                        }
                                                            ...
                                                            <div class="col-md-12 pt-4 pb-2">
                                                                <button class="btn btn-success tehvil_al"><i class="fa fa-check"></i> Tehvil Al</button>
                                                                <?php
                                                            ...
                                                            <div class="col-md-12 pt-4 pb-2">
                                                                <table class="table">
                                                                    <thead>
                                                                    <tr>
                                                                        <td><input type="checkbox" class="all_tehvil_cari_list" style="margin-left: 19px;"></td>
                                                                        <th>Cari Adı</th>
                                                                        <th>Tehvil Teslim Aktı</th>
                                                                        <th>Seçili Olanı Görüntüle</th>
                                                                    </tr>
                                                                    ...
                                                                    <?php if(onaylanan_firma_list($details->id)){
                                                                        ...
                                                                        foreach (onaylanan_firma_list($details->id) as $cari_list){
                                                                            ...
                                                                            <tr>
                                                                                <td><label class="checkbox">
                                                                                        <input type="checkbox" cari_id="<?php echo $cari_list->cari_id ?>" eq="<?php echo $i;?>" item_id="<?php echo $cari_list->id ?>" class="one_tehvil_cari_list"><i style="top: 12px;"></i>
                                                                                    </label>
                                                                                </td>
                                                                                <td><?php echo customer_details($cari_list->cari_id)['company']?></td>
...
<!--                                                                --><?php // if($details->status==7) { ?>
                                                                    <div class="col-md-12 pt-4 pb-2">
                                                                        <button class="btn btn-success tehvil_update"><i class="fa fa-check"></i> Senedleri Güncelle</button>
                                                                        <button class="btn btn-info qaime_asama_update"><i class="fa fa-file"></i> Tehvil İşlemlerini Bitir</button>
                                                                        ...
                                                                        foreach (tehvil_products($details->id) as $product_items){
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php
                                                                                    ...
                                                                                    $kalan = tehvil_cari_form_product($product_items->cari_id,$details->id,$product_items->product_id,$product_items->talep_form_product_id,$product_items->id)['kalan'];
                                                                                    ?></td>
                                                                                <td><?php echo customer_details($product_items->cari_id)['company'] ?></td>
                                                                                <td><?php echo amountFormat_s($product_items->qty) .' '.units_($product_items->unit_id)['name']?></td>
                                                                                <td><?php echo amountFormat_s($kalan_miktar).' '.units_($product_items->unit_id)['name']?></td>
...
<script src="<?php echo  base_url() ?>app-assets/talepform/create.js?v=<?php echo rand(11111,99999)?>"></script>
...
<script type="text/javascript">
    ...
    $(document).on('click','#teklif_incele',function (){
        ...
        $.confirm({
            ...
            content: function () {
                ...
                let table_report='';
                $.post(baseurl + 'malzemetalep/teklif_incele_ajax',data,(response) => {
            ...
            buttons: {
                ...
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/teklif_onay',data,(response)=>{
                ...
                moreButtons: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/teklif_onay_proje_muduru_onayi',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
    ...
    $(document).on('click','.form_add_products',function (){
        ...
        if(talep_type==3){
            $.post(baseurl + 'malzemetalep/create_form_items_gider',$('#data_form').serialize(),(response)=>{
                let responses = jQuery.parseJSON(response);
                if(responses.status=='Success'){
                    $('#loading-box').addClass('d-none');
                    $.alert({
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.post(baseurl + 'malzemetalep/onay_olustur_stok_kontrol',data,(response)=>{
                                let responses = jQuery.parseJSON(response);
                                if(responses.status=='Success'){
                                    $('#loading-box').addClass('d-none');
                                    $.alert({
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.post(baseurl + 'malzemetalep/onay_olustur',data,(response)=>{
                                let responses = jQuery.parseJSON(response);
                                if(responses.status=='Success'){
                                    $('#loading-box').addClass('d-none');
                                    $.alert({
    ...
    $(document).on('click','.product_move',function (){
        ...
        if(checked_count==0){
            ...
            $.post(baseurl + 'malzemetalep/yetkili_kontrol',data_update,(response)=>{
                let responses = jQuery.parseJSON(response);
                if(responses.status=='Success'){
                    $('#loading-box').addClass('d-none');
                        ...
                        buttons: {
                            formSubmit: {
                                ...
                                action: function () {
                                    ...
                                    $.post(baseurl + 'malzemetalep/product_move',data_update,(response)=>{
                                        let responses = jQuery.parseJSON(response);
                                        if(responses.status==200){
                                            $('#loading-box').addClass('d-none');
                                            $.alert({
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col col-xs-12 col-sm-8 col-md-8">
                        <div class="jarviswidget">
                            <header><h4>Malzeme Cari Arama Alanı</h4></header>
                            <div class="borderedccc">
                                <div class="widget-body">
                                    <div class="col col-xs-12 col-sm-12 col-md-12">
                                        <fieldset>
    ...
    $(document).on('click','.sales_person_update',function (){
        ...
        $.confirm({
            ...
            <form action="" class="formName">
                <div class="form-group">
                            <select class="form-control select-box" id="sales_personel_id">
                                    <?php  $k=0; foreach (all_personel() as $emp){
            ...
            if($k==0){
                ?>
                 <option  value="1093">Mustafazadə Ruslan Ağamir</option>
<?php
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/sales_personel_update',data_update,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/payment_personel_update',data_update,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/warehouse_update',data_update,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/transfer_status_change',data_update,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status==200){
                                $('#loading-box').addClass('d-none');
                                $.alert({
    ...
    $(document).on('click','#talep_list_get',function (){
        ...
        $.post(baseurl + 'malzemetalep/talep_list_get',data,(response)=>{
            let responses = jQuery.parseJSON(response);
            if(responses.status=='Success'){
                $('#loading-box').addClass('d-none');
                $.alert({
    ...
    $(document).on('click','#search_button',function (){
        ...
        if(category_id==0){
            if(keyword.length < 3){
                ...
                $.post(baseurl + 'malzemetalep/search_products',data,(response)=>{
                    let responses = jQuery.parseJSON(response);
                    if(responses.status=='Success'){
                        $('#loading-box').addClass('d-none');
                        $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/talep_asama_update',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/qaime_status',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/sened_status',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/confirm_status',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
                ...
                if(responses.status=='Success'){
                    ...
                    $.confirm({
                        ...
                        content: function () {
                            ...
                            let table_report='';
                            $.post(baseurl + 'malzemetalep/qaime_ajax',data,(response) => {
                                self.$content.find('#person-list').empty().append(html);
                                table_report=response;
                                $('.list').empty().html(table_report);
                        ...
                        buttons: {
                            formSubmit: {
                                ...
                                action: function () {
                                    ...
                                    $.post(baseurl + 'malzemetalep/qaime_create',data,(response)=>{
                                        let responses = jQuery.parseJSON(response);
                                        if(responses.status=='Success'){
                                            $('#loading-box').addClass('d-none');
                                            $.alert({
    ...
    function draw_data_notes_report(talep_id=0) {
        $('#notes_report').DataTable({
            ...
            'ajax': {
                'url': "<?php echo site_url('malzemetalep/ajax_list_notes')?>",
                'type': 'POST',
                'data': {
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/notes_delete',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status=='Success'){
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/status_upda',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status==200){
                                $.alert({
        ...
        $.confirm({
            ...
            content: function () {
                ...
                let table_report='<table class="table" style="text-align: initial;" id="cari_details">' +
                    ...
                    '<th>Yeni Cari</th>' +
                    '</tr></thead></tr><tbody>';
                $.post(baseurl + 'malzemetalep/talep_form_teklif_cari_details',data,(response) => {
                    self.$content.find('#person-list').empty().append(html);
                    let responses = jQuery.parseJSON(response);
                    if(responses.status==200){
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/mt_cari_update',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status==200){
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/transfer_bildirimi',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status==200){
                                $.alert({
...
`;
                ...
                let table_report='';
                $.post(baseurl + 'malzemetalep/talep_pay_info',data,(result) => {
                    self.$content.find('#person-list').empty().append(html);
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/talep_pay',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status==200){
                                $.alert({
    ...
    $(document).on('change','#cari_id_pay',function (){
        ...
        let table_report='';
        if(id!=0){
            $.post(baseurl + 'malzemetalep/talep_pay_cari_transactions',data,(result) => {
                let response = jQuery.parseJSON(result);
                if(response.status==200){
...
<div class="list">
                ...
                let table_report='';
                $.post(baseurl + 'malzemetalep/transfer_details',data,(result) => {
                    self.$content.find('#person-list').empty().append(html);
                    let response = jQuery.parseJSON(result);
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'malzemetalep/transfer_change_new',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status==200){
                                $.alert({
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.post(baseurl + 'malzemetalep/product_duzenle',data,(response)=>{
                                let responses = jQuery.parseJSON(response);
                                if(responses.status=='Success'){
                                    $('#loading-box').addClass('d-none');
                                    $.alert({
...
<textarea class="form-control" id="sms_mesaji">`+message+`</textarea>
             ...
             let table_report='';
             $.post(baseurl + 'malzemetalep/get_all_cari_sms',data,(response) => {
                 self.$content.find('#person-list').empty().append(html);
                 let responses = jQuery.parseJSON(response);
         ...
         buttons: {
             formSubmit: {
                 ...
                 action: function () {
                     ...
                     $.post(baseurl + 'malzemetalep/hesap_faktura_sms',data,(response)=>{
                         let responses = jQuery.parseJSON(response);
                         if(responses.status=='Success'){
                             $('#loading-box').addClass('d-none');
                             $.alert({
