    ...
    <script type="text/javascript">
        ...
        function draw_data(status_id=0,transfer_status=-1) {
            $('#invoices').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('malzemetalep/ajax_list')?>",
                    'type': 'POST',
...
<div class="form-row">
 <div class="form-group col-md-3">
      ...
      <select class="form-control select-box required" id="talep_type">
           <option value="1">Meteryal Talebi</option>
    </select>
    </div>
 <div class="form-group col-md-3">
                                ...
                                buttons: {
                                    formSubmit: {
                                        ...
                                        action: function () {
                                            ...
                                            var proje_id = parseInt($('#proje_id').val());
                                            var bolum_id = parseInt($('#bolum_id').val());
                                            var asama_id = parseInt($('#asama_id').val());
                                            if(!proje_id){
                                                $.alert({
                                                    theme: 'material',
                                            ...
                                            $.post(baseurl + 'malzemetalep/create_save',data,(response) => {
