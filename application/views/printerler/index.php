<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold"> Printer / Bilgisayar Tanımlamaları</span></h4>
...
<script>
    ...
    function draw_data() {
        $('#units_table').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': baseurl + 'printerler/ajax_list',
                'type': 'POST',
                'data': {}
            },
            'columnDefs': [{
                            ...
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function() {
                                        ...
                                        $.post(baseurl + 'printerler/create', data_post, (response) => {
                                ...
                                buttons: {
                                    formSubmit: {
                                        ...
                                        action: function() {
                                            ...
                                            $.post(baseurl + 'printerler/barcode_creates', data_post, (response) => {
                                                let data = jQuery.parseJSON(response);
                                                if (data.code == 200) {
                                                    $.alert({
                                                        theme: 'modern',
         ...
         <div>
           ...
           <div id="progress" class="progress">
            ...
            <input type="hidden" class="image_text_update" name="image_text_update" id="image_text_update">
                ...
                let table_report = '';
                $.post(baseurl + 'printerler/info', data, (response) => {
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function() {
                        ...
                        $.post(baseurl + 'printerler/update', data_post, (response) => {
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function() {
                        ...
                        $.post(baseurl + 'printerler/delete', data, (response) => {
                            let responses = jQuery.parseJSON(response);
