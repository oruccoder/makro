<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold"><?php echo $details->code?> Kodlu Malzeme Talebini Gider Olarak İşle</span></h4>
                                        ...
                                        <tbody>
                                            <?php if($items) {
                                                foreach ($items as $values){
                                                    $i=1;
                                                    $units = units_($values->new_unit_id)['name'];
                                                    $price = amountFormat($values->new_item_price);
                                                    $qty = amountFormat_s($values->new_item_qty);
                                                    $umumi_cemi = amountFormat($values->item_umumi_cemi_hidden);
                                                    $id = $details->id;
...
<td>
  <label class='checkbox'>
                                                                                            ...
                                                                                            talep_form_product_id='$values->talep_form_product_id' 
                                                                                            new_unit_id='$values->new_unit_id' 
                                                                                            new_item_price='$values->new_item_price' 
                                                                                            new_item_qty='$values->new_item_qty' 
                                                                                            item_umumi_cemi_hidden='$values->item_umumi_cemi_hidden' 
