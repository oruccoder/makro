                        ...
                        <form action="#">
                            <fieldset class="mb-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="button" name="search" id="search_gider" value="Filtrele" class="btn btn-info btn-md"/>
                                    </div>
                                    <div class="col-lg-2">
...
<script>
    ...
    function draw_data(start_date='',end_date) {
        $('#demisbas_list').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': "<?php echo site_url('demirbas/ajax_list_gider')?>",
                'type': 'POST',
                'data': {
