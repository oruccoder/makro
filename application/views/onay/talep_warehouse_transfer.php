<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Mahsul talebi anbar transferi </span></h4>
    ...
    <script type="text/javascript">
        ...
        function draw_data() {
            $('#invoices').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('stocktransfer/talep_transfer_onay_list')?>",
                    'type': 'POST',
            ...
            if (checked_count == 0) {
                ...
                $.confirm({
                    ...
                    content:`<form class="formName">
                        ...
                        <p>Güncellemek Üzeresiniz Emin Misiniz?<p/></div>
                        <div class="form-group hidden_div">
                        <select class="form-control select-box stock_fis_id">
                        <option value='0'>Seçiniz</option>
                        <?php
                            foreach (stock_fis_list() as $row) {
                                $cid = $row->id;
                                $title = $row->code;
                        ...
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                let data = {
                                    ...
                                    stock_fis_id: $('.stock_fis_id').val(),
                                }
                                $.post(baseurl + 'stocktransfer/talep_transfer_update',data,(response)=>{
