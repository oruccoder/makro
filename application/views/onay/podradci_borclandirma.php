<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Podradçı / Personel Borçlandırma Talepleri</span></h4>
                                    ...
                                    <div class="col-12 mb-4">
                                        <table id="cari_gider_talep_list" class="table datatable-show-all" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>Talep Kodu</td>
                                                <td>Tip</td>
                                                <td>Borçlandırılan Şahıs</td>
                                                <td>Tutar</td>
                                                <td>Görüntüle</td>
                                                <td>Onayla / İptal Et</td>
                                            </tr>
                                            </thead>
                                        </table>
                                    </div>
...
<script>
    ...
    function draw_data(aauth = 'absent',) {
        $('#cari_gider_talep_list').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': "<?php echo site_url('transactions/ajax_list_bekleyen_podradci_borclandirma')?>",
                'type': 'POST',
                'data': {
    ...
    $(document).on('click', ".onay_iptal", function (e) {
        ...
        $.confirm({
            ...
            content:'<form action="" class="formName">' +
                ...
                '<p>Talep Durum Bildirmek Üzeresiniz?<p/>' +
                '<input type="text" id="desc" class="form-control desc" placeholder="İptal Sebebi Zorunludur">' +
                '</div>' +
                '<div class="form-group">' +
                '<p>Durum<p/>' +
                '<select class="form-control durum"><option value="1">Onayla</option><option value="2">İptal Et</option></select>' +
                '</div>' +
                '</form>',
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        let data = {
                            ...
                            borclandirma_id:  talep_id,
                            desc:  desc,
                            durum: durum
                        }
                        $.post(baseurl + 'transactions/podradci_status_change',data,(response) => {
