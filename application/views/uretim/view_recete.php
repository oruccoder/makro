                                                        ...
                                                        <div class="jarviswidget mb-3">
                                                            <div class="borderedccc no-padding">
                                                                <div class="widget-body" style="padding: 15px;">
                                                                    ...
                                                                    <a type="button" class="btn btn-warning" href="/uretim/print_recete/<?php echo $details->id?>" target="_blank"><i class="fa fa-print"></i> Yazdır</a>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="vert-align-mid" >
                                                                                            ...
                                                                                            ?>
                                                                                              ...
                                                                                              <span class="txt-color-darken no-padding " data-popup="popover" title="" data-trigger="hover" data-content="<?php echo str_replace($search,'',$option_html)?>" data-original-title="Varyasyolar"><b><?php echo ' <b>'.product_details($details->new_prd_id)->product_name.'</b>';?></b></span>
