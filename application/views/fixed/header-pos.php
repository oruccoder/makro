...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?= base_url() ?>app-assets/<?= LTR ?>/core/menu/menu-types/horizontal-menu.css">
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
          href="<?= base_url() ?>app-assets/<?= LTR ?>/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>app-assets/<?= LTR ?>/pages/chat-application.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
