...
<!--                            </li>-->
                ...
                ?>
                    ...
                    <?php if ($this->aauth->get_user()->id == 21 || $this->aauth->get_user()->id == 39 || $this->aauth->get_user()->id == 61 || $this->aauth->get_user()->id == 1007 || $this->aauth->get_user()->id == 62) {
                    ?>
                        <li data-menu="">
        ...
        ?>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="icon-note"></i><span><?php echo $this->lang->line('Miscellaneous') ?></span></a>
                <ul class="dropdown-menu">
                    ...
                    <li data-menu="">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>customermeeting"><i class="icon-note"></i>Randevuler</a>
                    </li>
                    <li data-menu="">
