            ...
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select name="gorev_tipi" class="form-control">
                            <?php  if($task['gorev_tipi']==1)
                            {
                                ?>
                                <option selected value="1">Hizmet</option>
                            ...
                            else
                            {
                                ...
                                <option selected value="2">Stok</option>
                                <?php
                            }?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input name="name" value="<?php echo $task['name'];?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="number" value="<?=$task['quantity'] ?>" class="form-control" name="quantity" id="quantity">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text"  value="<?=$task['fiyat'] ?>" class="form-control" name="fiyat" id="fiyat">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input  value="<?=$task['oran'] ?>" class="form-control" name="oran" id="oran">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text"   value="<?=$task['toplam_fiyat'] ?>" class="form-control" name="toplam_fiyat" id="toplam_fiyat">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select name="priority" class="form-control">
                            <option  <?php if($task['priority'] == 'Low' ) echo 'selected'; ?> value='Low'>Düşük</option>
                            <option <?php if($task['priority'] == 'Medium' ) echo 'selected'; ?> value='Medium'>Orta</option>
                            <option <?php if($task['priority'] == 'High' ) echo 'selected'; ?> value='High'>Yüksek</option>
                            <option <?php if($task['priority'] == 'Urgent' ) echo 'selected'; ?> value='Urgent'>Acil</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select name=simeta_status class="form-control" id="simeta_status">
                            <?php if($task['simeta_status']==1)
                            {
                                ?>
                                <option selected value="1">İş Listesinde Var</option>
                                <option value="2">İş Listesinde Yok</option>
                                <?php
                            } else {
                                ?>
                                <option  value="1">İş Listesinde Var</option>
                                <option selected value="2">İş Listesinde Yok</option>
                                <?php
                            } ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control required editdate"
                               placeholder="Start Date" name="staskdate" value="<?=$task['start']?>"
                               autocomplete="false">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control required editdate"
                               placeholder="End Date" name="taskdate" value="<?=$task['duedate']?>"
                               autocomplete="false">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" value="projects/update_task" id="action-url">
                        <input type="hidden" value="<?php echo $task['id']?>" name="task_id">
                        <input type="hidden" value="<?php echo $proje_id ?>" name="proje_id">
                    </div>
