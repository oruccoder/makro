<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Cari Ceza Talebi</span></h4>
    ...
    $(document).ready(function () {
        ...
        function draw_data(aauth = 'absent',) {
            $('#cari_gider_talep_list').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('caricezatalep/ajax_list')?>",
                    'type': 'POST',
                    'data': {
...
<div class="form-row">
 <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      <label for="asama_id">Ceza Ödeme Türü</label>
...
<div class="form-row">
 <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      <label for="firma_id">Ceza Verilecek İtem</label>
                                ...
                                buttons: {
                                    formSubmit: {
                                        ...
                                        action: function () {
                                            ...
                                            $.post(baseurl + 'caricezatalep/create_save',data,(response) => {
