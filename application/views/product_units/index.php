<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold"> Ölçü birimleri </span></h4>
...
<script>
    ...
    function draw_data() {
        $('#units_table').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': baseurl + 'newunits/ajax_list',
                'type': 'POST',
                'data': {}
            },
            'columnDefs': [{
                            ...
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function() {
                                        ...
                                        $.post(baseurl + 'newunits/create', data_post, (response) => {
    ...
    $(document).on('click', '.edit', function() {
        ...
        $.confirm({
            ...
            `;
                ...
                let table_report = '';
                $.post(baseurl + 'newunits/info', data, (response) => {

                    self.$content.find('#person-list').empty().append(html);
                    let responses = jQuery.parseJSON(response);

                    $('.name').val(responses.details_items[0].name)
                    $('.code').val(responses.details_items[0].code)
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function() {
                        ...
                        $.post(baseurl + 'newunits/update', data_post, (response) => {
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function() {
                        ...
                        $.post(baseurl + 'newunits/delete', data, (response) => {
                            let responses = jQuery.parseJSON(response);
