<article class="content">
    <div class="card card-block">
        ...
        <div class="grid_3 grid_4">
            <h5 class="title">
                <?php echo $this->lang->line('Employee').' : '.$employee['name']  ?> <a href="<?php echo base_url('employee/view?id='.$employee['id']) ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to deactivate this account ? <br><strong> It will disable this account access to
                        user.</strong></p>
            </div>
