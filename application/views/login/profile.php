                            ...
                            <div>
                                ...
                                <div class="ibox-content profile-content">
                                    ...
                                    <div class="row m-t-lg">
                                     ...
                                     <div class="row m-t-lg">
                                        <div class="col-md-12">
                                            <strong><?php echo $this->lang->line('Salary') ?></strong> <?php echo currency($this->aauth->get_user()->loc);   echo ' '.$employee['salary']; ?>
                                        </div>
 ...
 <div class="col-sm-6">
                                        <div class="hero-widget well well-sm">
                                            ...
                                            <div class="text">
                                                ...
                                                <label class="text-muted"><?php echo $this->lang->line('Salary') ?></label>
                                            </div>
                                            <div class="options">
                                                <a href="<?php echo base_url('user/salary?id=' . $eid) ?>"
                                                   class="btn btn-primary btn-lg"><i class="icon-eye"></i> <?php echo $this->lang->line('View') ?></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
