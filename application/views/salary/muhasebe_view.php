...
<tr>
    ...
    function draw_data() {
        $('#project_table').DataTable({
            ...
            buttons: [
                {
                    text: '<i class="fa fa-user-plus"></i> Tüm Verileri Güncelle',
                            ...
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function () {
                                        ...
                                        $.post(baseurl + 'salary/create_all_islem',data,(response) => {
                                            let responses = jQuery.parseJSON(response);
                                            $('#loading-box').addClass('d-none');
                                            if(responses.status==200){
                                                $.alert({
                ...
                {
                    text: '<i class="fa fa-user-plus"></i> Ödeniş Emri Ver',
                    action: function ( e, dt, node, config ) {
 ...
 <label for="name">Method</label>
    ...
    <div class="form-group col-md-12">
      <label for="name"></label>
        <select class="form-control select-box name" name="pers_id" id="pers_id">
            <option value="0">Ödeme Yapacak Personel Seçiniz</option>
        </select>
    </div>
</div>`
                                let data = {
                            ...
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function () {
                                        ...
                                        $.post(baseurl + 'salary/create_pay_set',data,(response) => {
                                            let responses = jQuery.parseJSON(response);
                                            $('#loading-box').addClass('d-none');
                                            if(responses.status==200){
                                                $.alert({
                ...
                {
                    text: '<i class="fa fa-user-plus"></i> Hakediş Ver',
                    action: function ( e, dt, node, config ) {
    ...
    <div class="form-group col-md-12">
      ...
      <select class="form-control status" id="status">
                                ...
                                formSubmit: {
                                    ...
                                    action: function () {
                                        ...
                                        let data = {
                                            bordro_details:  bordro_details,
                                            bordro_id:<?php echo $details->id?>,
                                            status_onay:status_onay,
                                        }
                                        $.post(baseurl + 'salary/create_hakedis',data,(response) => {
                                            let responses = jQuery.parseJSON(response);
                                            $('#loading-box').addClass('d-none');
                                            if(responses.status==200){
                                                $.alert({
                ...
                {
                    text: '<i class="fa fa-user-plus"></i> Durum Değiştir',
                    action: function ( e, dt, node, config ) {
...
<div class="form-group col-md-12">
      ...
      <input type="text" class="form-control desc" placeholder="Onaylıyorum">
    </div>
    <div class="form-group col-md-12">
      <label for="name">İşlem Yap</label>
      <select class="form-control status" id="status">
                <option value="6">Onayla</option>
                <option value="4">Pasif</option>
                <option value="5">Tekrar Bordro İste</option>
            </select>
    </div>
</div>`,
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function () {
                                        ...
                                        $.post(baseurl + 'salary/create_onay_new',data,(response) => {
                                            let responses = jQuery.parseJSON(response);
                                            $('#loading-box').addClass('d-none');
                                            if(responses.status==200){
                                                $.alert({
