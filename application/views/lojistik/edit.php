<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Lojistik Talebi Düzenle</span></h4>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group row">
                                                        <div class="col-md-3">
                                                            <input type="hidden" value="<?php echo  $details->id ?>" id="lojistik_id">
                                                ...
                                                <div class="col-sm-12">
                                                    <table class="table lojistik_table lojistik_table">
                                                        <thead>
                                                        <tr>
                                                            <td width="20%">Proje</td>
                                                            <td width="20%">Başlangıç ve Bitiş Noktası</td>
                                                            <td width="15%">Açıklama</td>
                                                            <td width="20%">Sf No</td>
                                                            <td width="10%">Araç</td>
                                                            <td>Miktar</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select class="form-control location" multiple="multiple" name="location[]">
                                                                        <?php foreach (lojistik_items_location_($details->id,$values->id,1) as $items){
                                                                            echo "<option selected value='$items->location'>$items->location</option>";
                                                                        }?>
                                                                    </select>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <select class="form-control select-box sf_id" multiple="multiple" name="sf_id[]">
                                                                        <?php foreach (lojistik_items_sf_($details->id,$values->id,1) as $items){
                                                                            echo "<option selected value='$items->id'>$items->talep_no</option>";
                                                                        }?>
                                                                    </select>
                                                                </td>
                                                                <td>
...
<script>
        ...
        ?>
                ...
                <?php } ?>
                   ...
                   <td>
                        ...
                        <?php foreach (araclar() as $emp){
        ?>
                            <option value="<?php echo $emp->id; ?>"><?php echo $emp->name.'-'.$emp->company; ?></option>
                        <?php } ?>
                        </select>
                </td>
    ...
    $(document).on('click', "#talep_create", function (e) {
        $.confirm({
            ...
            draggable: false,
            content: 'Lojistik Talebi Düzenlemek Üzeresiniz Emin Misiniz?',
            buttons: {
                formSubmit: {
                    text: 'Güncelle',
                    btnClass: 'btn-blue',
                    action: function () {
                        ...
                        let data = {
                            ...
                            desc : $('#desc').val(),
                            lojistik_id : $('#lojistik_id').val(),
                            product_details:product_details,
                            crsf_token: crsf_hash,
                        }
                        $.post(baseurl + 'lojistik/update_save',data,(response)=>{
