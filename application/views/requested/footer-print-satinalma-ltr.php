...
<table  style="font-size: 12px">
    ...
    <tr>
        <td style="text-align: center"><b>HAZIRLAYAN</b></td>
        <td style="text-align: center"><b>SATINALMA PERSONELİ</b></td>
        <td style="text-align: center"><b>SATINALMA MÜDÜRÜ</b></td>
        ...
        <td style="text-align: center"><b>FİNANS DEPARTMANI</b></td>
    </tr>
    <tr>
        ...
        <td style="text-align: center">
            <?php echo personel_details($invoice['satinalma_personeli']) ?>


        </td>
        <td style="text-align: center">
            <?php echo personel_details($invoice['satinalma_mudur_id']) ?>
        ...
        <td style="text-align: center">
            <?php echo personel_details($invoice['finans_departman_pers_id']) ?>
