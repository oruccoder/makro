    ...
    <div class="card">
        <div class="card-content">
            ...
            <option value='0'>Seçiniz</option>$opt
                                            ...
                                            <tr>
                                                <th colspan="3" scope="row"><a href="/billing/satinalma_talep_olustur?pers_id=<?php echo $_GET['pers_id'] ?>&id=<?php echo $_GET['id'] ?>&token=<?php echo $_GET['token'] ?>" class="btn btn-info btn-xs">Satın Alma Olustur</a></th>
                                            </tr>
