                                            ...
                                            <div class="mb-3">
                                                <div class="no-padding">
                                                    <div class="widget-body">
                                                        <a href="/carigidertalepnew" class="btn btn-secondary" data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="İstek Siyahısı"><i class="fa fa-arrow-left"></i></a>
                                                        <a target="_blank" href="/carigidertalepnew/print/<?php echo $details->id ?>" class="btn btn-secondary" data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="Yazdır"><i class="fa fa-print"></i></a>
                                                        ...
                                                        <?php if($details->status==10){
                                                            ?>
                                                            <button type="button" class="btn btn-secondary talep_reverse" talep_id="<?php echo $details->id ?>" ><i class="fa fa-reply"></i> İptal İşlemini Geri Al</button>
                                                        ...
                                                        <?php if($details->gider_durumu){
                                                            ...
                                                            <button class="btn btn-secondary"  data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="Gidere İşlenmiştir"><i class="fa fa-info"></i></button>
                                                            <?php

                                                        } else {

                                                            ?>
                                                            <button type="button" class="btn btn-secondary gider_isle" talep_id="<?php echo $details->id ?>"  data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="Talebi Gidere İşle"><i class="fa fa-file"></i></button>

                                                            <?php
                                                        } ?>
                                                        <?php if($details->invoice_durumu){
                                                            ?>

                                                            <button class="btn btn-secondary"  data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="Faturalaşmıştır"><i class="fa fa-info"></i></button>
                                                            <?php

                                                        } else {

                                                            ?>
                                                            <button type="button" class="btn btn-secondary invoice_isle" talep_id="<?php echo $details->id ?>"  data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="Talebi Faturalaştır"><i class="fa fa-file"></i></button>
                                                        ...
                                                        <button  islem_tipi="4" islem_id="<?php echo  $details->id ?>" type="button" class="btn btn-secondary  add_not_new"   data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="Not Ekle"><i class="fa fa-notes-medical"></i></button>
                                                        <button  onclick="details_notes()" type="button" class="btn btn-secondary button_view_notes"   data-original-title="Bilgilendirme"   data-popup="popover" data-trigger="hover" data-placement="top" data-content="Notları Görüntüle"><i class="fa fa-list-alt"></i></button>
                                                        ...
                                                        <button  type="button" class="btn btn-secondary button_podradci_borclandirma" islem_id="<?php echo $details->id ?>" islem_tipi="2" tip="create" data-popup="popover" data-trigger="hover" data-placement="top" data-original-title="Bilgilendirme"  data-content="Podradçi / Personel Borçlandır"><i class="fa fa-credit-card"></i></button>
                                                        <button  type="button" class="btn btn-secondary button_podradci_borclandirma" islem_id="<?php echo $details->id ?>" islem_tipi="2" tip="talep" data-popup="popover" data-trigger="hover" data-placement="top" data-original-title="Bilgilendirme"  data-content="Podradçi / Personel Borçlandırma Talep Et"><i class="fa fa-money-bill-wave-alt"></i></button>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-responsive">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="vert-align-mid"><span class=" txt-color-darken no-padding">Talebi Açan: </span></td>
                                                                            <td class="vert-align-mid" colspan="2">
                                                                                <span class=" txt-color-darken no-padding no-margin"><b><?php echo personel_details($details->aauth)?></b></span>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
                                                                ...
                                                                <?php if($items){  //varsa ?>
                                                                    ...
                                                                    <table class="table ">
                                                                        ...
                                                                        foreach ($items as $values) {
                                                                            ...
                                                                            $connect_details  = $this->db->query("SELECT * FROM gider_sepet_connect Where item_id = $values->id")->row();

                                                                            $html =  demirbas_html($connect_details->demirbas_id, $connect_details->firma_demirbas_id);
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="6" style="text-align: end"><span style="font-weight: bold">Genel Toplam</span></td>
                                                                            <td><span style="font-weight: bold"><?php echo amountFormat($totals) ?></span></td>
                                                                        </tr>
                                                                    ...
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                ?>
                                                                                <!--                                                                            tutar="--><?php //echo $odeme_details['toplam_tutar_float'] ?><!--"-->

                                                                                <?php if($kalan > 0 ) {
                                                                                    ?>
                                                                                    <button <?php echo $disabled_odeme;?> tutar="<?php echo $kalan ?>"  tip="on_odeme" type="button" eq="<?php echo $eq; ?>" class="btn btn-success form_transaction_payment"><i class="fa fa-check"></i></button>

                                                                                    <?php
                                                                                }
                                                                                else {
                                                                                    ?>
                                                                                    <button tutar="<?php echo $kalan ?>"  tip="tamamlama" type="button" eq="<?php echo $eq; ?>" class="btn btn-success form_transaction_payment"><i class="fa fa-check"></i> Ödeme Tamamlandı Bildir</button>
                                                                                ...
                                                                                if(!$details->alacak_durum){
                                                                                    ...
                                                                                    echo "<span class='badge badge-pill badge-secondary'>Cari Alacaklandırıldı ve Hizmet Tamamlandı</span>";
                                                                                }
                                                                                ?>
                                                                            </td>
                                                                        </tr>
                                                ...
                                                <div class="col col-md-6 col-xs-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                            <?php if(talep_borclandirma($details->id,2)){
                                                                foreach (talep_borclandirma($details->id,2) as $b_items){
                                                                    ?>
                                                                    <tr>
...
'></i>";
                                                                ...
                                                                foreach (talep_onay_customer_new(1,$details->id) as $items) {
                                                                    ...
                                                                    if($items->staff==1 && $items->status==0){
                                                                        $durum='Gözləmedə';
                                                                        $button='<button class="btn btn-info onayla" aauth_id="'.$this->aauth->get_user()->id.'" user_id="'.$items->user_id.'" sort="'.$items->sort.'"><i class="fa fa-check"></i>&nbsp;Təsdiq Edin</button>'.$button_dikkat;
                                                                    }
                                                                    ?>
                                                                    <tr>
                                                                ...
                                                                <?php
                                                                if(talep_onay_customer_new(2,$details->id)){
                                                ...
                                                <div class="col col-md-12 col-xs-12" style="margin-top: 30px;">
                                                    <div class="jarviswidget">
...
<script>
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/update_form',data,(response)=>{
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/upload_file',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status=='Success'){
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/delete_file',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
    ...
    $(document).on('click','.add_items',function (){
        $('#loading-box').removeClass('d-none');
        $.post(baseurl + 'carigidertalepnew/create_form_items',$('#data_form').serialize(),(response)=>{
            let responses = jQuery.parseJSON(response);
            if(responses.status=='Success'){
                $('#loading-box').addClass('d-none');
                $.alert({
    ...
    $(document).on('click','#search_button',function (){
        ...
        if(category_id==0){
            if(keyword.length < 3){
                ...
                $.post(baseurl + 'carigidertalepnew/search_products',data,(response)=>{
                    let responses = jQuery.parseJSON(response);
                    if(responses.status=='Success'){
                        $('#loading-box').addClass('d-none');
                        $.alert({
    ...
    $(document).on('click','.form_add_products',function (){
        ...
        $.post(baseurl + 'carigidertalepnew/create_form_items',data,(response)=>{
            let responses = jQuery.parseJSON(response);
            if(responses.status=='Success'){
                $('#loading-box').addClass('d-none');
                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/delete_item_form',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/update_item_form',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/customer_alacak_update',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/customer_payment_update',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.post(baseurl + 'carigidertalepnew/update_form_payment',data,(response)=>{
                                let responses = jQuery.parseJSON(response);
                                if(responses.status=='Success'){
                                    $('#loading-box').addClass('d-none');
                                    $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/form_bildirim_olustur',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.post(baseurl + 'carigidertalepnew/onay_olustur',data,(response)=>{
                                let responses = jQuery.parseJSON(response);
                                if(responses.status=='Success'){
                                    $('#loading-box').addClass('d-none');
                                    $.alert({
    ...
    function draw_data_notes_report(talep_id=0) {
        $('#notes_report').DataTable({
            ...
            'ajax': {
                'url': "<?php echo site_url('carigidertalepnew/ajax_list_notes')?>",
                'type': 'POST',
                'data': {
                            ...
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function () {
                                        ...
                                        $.post(baseurl + 'carigidertalepnew/create_save_notes',data,(response) => {
                                            let responses = jQuery.parseJSON(response);
                                            $('#loading-box').addClass('d-none');
                                            if(responses.status=='Success'){
                                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalepnew/notes_delete',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status=='Success'){
                                $.alert({
