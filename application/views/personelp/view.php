                                ...
                                <div class="card-body text-center">
                                    <div class="card-img-actions d-inline-block mb-3">
                                        <img class="img-fluid rounded-circle" id="profile_images"
                                             src="<?php echo base_url('userfiles/employee/' . pesonelp_picture_url($details->id)); ?>"
...
<script>
    ...
    $(function () {
        ...
        var url = '<?php echo base_url() ?>personelp/displaypic';
        $('#fileupload').fileupload({
            ...
            formData: {
                ...
                $.post(baseurl + 'personelp/update_image', data_update, (response) => {
    ...
    function draw_data(start_date = '', end_date = '') {
        $('#doctable').DataTable({
            ...
            <?php datatable_lang();?>
            "ajax": {
                "url": "<?php echo site_url('personelp/document_load_list')?>",
                "type": "POST",
                'data': {
           ...
           <div id="progress" class="progress">
            ...
            <input type="hidden" class="image_text" name="image_text" id="image_text">
                            ...
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function () {
                                        ...
                                        $.post(baseurl + 'personelp/create_file', data, (response) => {
                                            let responses = jQuery.parseJSON(response);
                                            $('#loading-box').addClass('d-none');
                                            if (responses.status == 200) {
                                                $.alert({
                            ...
                            onContentReady: function () {
                                ...
                                var url = '<?php echo base_url() ?>personelp/adddocument';
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'personelp/delete_document', data, (response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if (responses.status == 200) {
                                $.alert({
