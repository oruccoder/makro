<div class="page-header">
    <div class="page-header-content header-elements-lg-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Cari Avans Talebi</span></h4>
    ...
    $(document).ready(function () {
        ...
        function draw_data() {
            $('#cari_gider_talep_list').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('customeravanstalep/ajax_list')?>",
                    'type': 'POST',
                    'data': {
...
<div class="form-row">
 <div class="form-group col-md-6">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="firma_id">Tip</label>
        <select class="form-control select-box" id="avans_type">
                                        ...
                                        action: function () {
                                            ...
                                            if(!fiyat){
                                                $.alert({
                                                    ...
                                                    title: 'Dikkat!',
                                                    content: 'Avans Tutarı Zorunludur',
                                                    buttons:{
                                                        prev: {
                                                            text: 'Tamam',
                                            ...
                                            $.post(baseurl + 'customeravanstalep/create_save',data,(response) => {
                                ...
                                onContentReady: function () {
                                    ...
                                    $(document).on('change','#cari_id',function (){
                                        ...
                                        $.confirm({
                                            ...
                                            content: function () {
                                                let self = this;
                                                let html = '<p id="str"></p><div id="table_div"></div>'; // Yönlendirilmiş ve Tek Yapılan randevu 1,3
                                                let responses;
                                                ...
                                                let table_report='';
                                                $.post(baseurl + 'customers/cari_parent_kontrol',data,(response) => {
                                                    self.$content.find('#person-list').empty().append(html);
                                                    let responses = jQuery.parseJSON(response);
                                                    $('#str').empty().text(responses.messages);
                                                    $('#table_div').empty().html(responses.text);
                                                });
                                                self.$content.find('#person-list').empty().append(html);
