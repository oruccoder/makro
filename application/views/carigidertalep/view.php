                                            ...
                                            <div class="mb-3">
                                                <div class="no-padding">
                                                    <div class="widget-body">
                                                        <a href="/carigidertalep" class="btn btn-warning"><i class="fa fa-arrow-left"></i> İstək siyahısı</a>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-responsive">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="vert-align-mid" colspan="2">
                                                                            <span class=" txt-color-darken no-padding dgt_relatedPersons no-margin">
                                                                                <?php echo talep_odemeler($details->id,2); ?>
                                                                            </span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="vert-align-mid"><span class=" txt-color-darken no-padding">Bağlı Olduğu Demirbaş: </span></td>
                                                                        <td class="vert-align-mid" colspan="2">
                                                                            <span class=" txt-color-darken no-padding no-margin"><b><button type="button" id="demirbas_sec" class="btn btn-success">Demirbaş Seçiniz</button></b></span>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col col-md-8 col-xs-12">
                                                    <div class="jarviswidget">
                                                        ...
                                                        <table class="table">
                                                            <?php foreach (talep_onay_customer_new(1,$details->id) as $items) {
                                                                $durum='-';
                                                                ...
                                                                if($items->staff==1 && $items->status==0){
                                                                    $durum='Gözləmedə';
                                                                    $button='<button class="btn btn-info onayla" aauth_id="'.$this->aauth->get_user()->id.'" user_id="'.$items->user_id.'"><i class="fa fa-check"></i>&nbsp;Təsdiq Edin</button>';
                                                                }
                                                                ?>
                                                                <tr>
                                                ...
                                                <div class="col col-md-12 col-xs-12">
                                                    <div class="jarviswidget">
                                                        ...
                                                        <?php if(talep_history_customer($details->id)){
                                                            ?>
                                                            <table class="table">
                                                                <thead>
                                                                <tr>
                                                                ...
                                                                <tbody>
                                                                <?php
                                                                foreach (talep_history_customer($details->id) as $items){
...
<script>
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalep/update_form',data,(response)=>{
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalep/upload_file',data,(response) => {
                            let responses = jQuery.parseJSON(response);
                            $('#loading-box').addClass('d-none');
                            if(responses.status=='Success'){
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalep/delete_file',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
    ...
    $(document).on('click','#search_button',function (){
        ...
        if(category_id==0){
            if(keyword.length < 3){
                ...
                $.post(baseurl + 'carigidertalep/search_products',data,(response)=>{
                    let responses = jQuery.parseJSON(response);
                    if(responses.status=='Success'){
                        $('#loading-box').addClass('d-none');
                        $.alert({
    ...
    $(document).on('click','.form_add_products',function (){
        ...
        $.post(baseurl + 'carigidertalep/create_form_items',data,(response)=>{
            let responses = jQuery.parseJSON(response);
            if(responses.status=='Success'){
                $('#loading-box').addClass('d-none');
                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalep/delete_item_form',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalep/update_item_form',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalep/customer_alacak_update',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalep/customer_payment_update',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.post(baseurl + 'carigidertalep/update_form_payment',data,(response)=>{
                                let responses = jQuery.parseJSON(response);
                                if(responses.status=='Success'){
                                    $('#loading-box').addClass('d-none');
                                    $.alert({
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'carigidertalep/form_bildirim_olustur',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
                            if(responses.status=='Success'){
                                $('#loading-box').addClass('d-none');
                                $.alert({
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.post(baseurl + 'carigidertalep/onay_olustur',data,(response)=>{
                                let responses = jQuery.parseJSON(response);
                                if(responses.status=='Success'){
                                    $('#loading-box').addClass('d-none');
                                    $.alert({
