                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" placeholder="Address"
                               class="form-control margin-bottom  required" name="address"  value="<?php echo $address ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group row">  <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('Company Logo') ?></label>
                         <div class="col-sm-6">
                        ...
                        <table id="files" class="files">
                            <tr><td><a data-url="<?php echo base_url() ?>locations/file_handling?op=delete&name=<?php echo $logo ?>" class="aj_delete"><i class="btn-danger btn-sm icon-trash-a"></i> <?php echo $logo ?> </a><img style="max-height:200px;" src="<?php echo base_url() ?>userfiles/company/<?php echo $logo ?>"></td></tr>
                        </table>
                        <br>
