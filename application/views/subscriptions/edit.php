...
<button type="button" data-rowid="' . $i . '" class="btn btn-danger removeProd" title="Remove"> <i class="icon-minus-square"></i> </button>
                        ...
                        <tr class="sub_c" style="display: table-row;">
                          ...
                          <td align="left" colspan="2"><input type="text" class="form-control shipVal"
                                                                ...
                                                                onkeyup="billUpyog()"
                                                                value="<?php if($invoice['ship_tax_type']=='incl'){ $invoice['shipping']=$invoice['shipping']+$invoice['ship_tax']; } echo $invoice['shipping'] ?>">( <?= $this->lang->line('Tax') ?> <?= $this->config->item('currency');?> <span id="ship_final"><?= $invoice['ship_tax'] ?> </span> )</td>
                        </tr>
