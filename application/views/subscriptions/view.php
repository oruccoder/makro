                    ...
                    <div class="row wrapper white-bg page-heading">
                        ...
                        <div class="col-lg-12">
                            ...
                            <span
                                ...
                                </div> <a href="#pop_model2" data-toggle="modal" data-remote="false"
                                   class="btn btn-large btn-grey  mb-1" title="Change Status"
                                ><span class="icon-tab"></span> <?php echo $this->lang->line('Subscription') ?> </a>
...
<p class="ml-2"><?=$loc['cname']?></p>
                        ...
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                            <h3><?php echo $this->lang->line('Subscription'); echo'</h2><h4><span class="st-sub' . $invoice['i_class'] . '">' . $this->lang->line('Sub_'.$invoice['i_class']) . '</span>'; ?></h3>
                    ...
                    <div class="row">
                        <table class="table table-striped">
                            ...
                            <?php foreach ($attach as $row) {
                                ...
                                echo '<tr><td><a data-url="' . base_url() . 'subscriptions/file_handling?op=delete&name=' . $row['col1'] . '&invoice=' . $invoice['iid'] . '" class="aj_delete"><i class="btn-danger btn-lg icon-trash-a"></i></a> <a class="n_item" href="' . base_url() . 'userfiles/attach/' . $row['col1'] . '"> ' . $row['col1'] . ' </a></td></tr>';
                            } ?>
            ...
            dataType: 'json',
             formData: {'<?=$this->security->get_csrf_token_name()?>': crsf_hash},
                ...
                $.each(data.result.files, function (index, file) {
                    $('#files').append('<tr><td><a data-url="<?php echo base_url() ?>subscriptions/file_handling?op=delete&name=' + file.name + '&invoice=<?php echo $invoice['iid'] ?>" class="aj_delete"><i class="btn-danger btn-sm icon-trash-a"></i> ' + file.name + ' </a></td></tr>');
