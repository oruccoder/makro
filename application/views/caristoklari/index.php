...
<script>
    ...
    function draw_data() {
        $('#invoices').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': "<?php echo site_url('caristoklari/ajax_stok_fis_list')?>",
                'type': 'POST',
                                            ...
                                            buttons: {
                                                ...
                                                formSubmit: {
                                                    ...
                                                    action: function () {
                                                        ...
                                                        $.post(baseurl + 'caristoklari/create_fis',data_post,(response)=>{
                            ...
                            if($('.bolum_radio:checked').length){
                                if(asama_kontrol){
                                    if($('.asama_radio:checked').length){
                                        ...
                                        proje_details_create(product_id,bolum_id,asama_id,tip,warehouse_id,proje_id,personel_id)
                                        mt_index++;
                                    }
                                    else {
                                        $.alert({
                            ...
                            buttons: {
                                formSubmit: {
                                    ...
                                    action: function () {
                                        ...
                                        $.post(baseurl + 'caristoklari/update_fis',data_post,(response)=>{
                                            let data = jQuery.parseJSON(response);
                                            if(data.status==200){
                                                $.alert({
                                                    theme: 'modern',
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.post(baseurl + 'caristoklari/delete_fis',data,(response)=>{
                            let responses = jQuery.parseJSON(response);
