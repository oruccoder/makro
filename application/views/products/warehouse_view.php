<div class="content-body">
    <div class="card">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <table id="productstable" class="table table-striped table-bordered zero-configuration" width="100%">
                    <thead>
                    <tr>
                        <th>#</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            table = $('#productstable').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('productcategory/warehouseproduct_list') . '?id=' . $_GET['id']; ?>",
                    "type": "POST",
