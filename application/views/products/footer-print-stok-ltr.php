...
<table  style="font-size: 12px">
    ...
    <tr>
        <td style="text-align: center"><b>Tehvil Veren Personel</b></td>
        <td style="text-align: center"><b>Tehvil Alan Personel</b></td>
    </tr>
    <tr>
        <td style="text-align: center">
            <?php echo personel_details($invoice['sorumlu_pers_id']) ?>
