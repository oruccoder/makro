                ...
                <form method="post" id="data_form" class="form-horizontal">
                    <div class="card card-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select id="wfrom" name="from_warehouse" class="form-control select-box">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-2 col-form-label"
                                   for="pay_cat"><?php echo $this->lang->line('Qty') ?></label>

                            <div class="col-sm-8">
                                <input name="products_qty" placeholder="Miktarları virgül ile ayırarak girebilirsiniz.Ör:10,20,30" class="form-control required" type="text">
