                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <input type="hidden" id="arac_id" value="<?php echo $details->id ?>">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" value="<?php echo $details->plaka ?>" type="text" id="plaka_no">
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label">Araç Adı</label>
                                    <input class="form-control" type="text" id="name" value="<?php echo $details->name ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
...
<script>
    ...
    $(document).on('click', "#talep_create", function (e) {
        $.confirm({
            ...
            draggable: false,
            content: 'Araç Düzenlemek Üzeresiniz Emin Misiniz?',
            buttons: {
                formSubmit: {
                    text: 'Güncelle',
                    btnClass: 'btn-blue',
