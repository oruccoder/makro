    ...
    var _scatterPieBasicLightExample = function() {
        ...
        if (pie_basic_element) {
            ...
            pie_basic.setOption({
                ...
                // Add title
                title: {
                    text: 'En Çok Satan Bayiler',
                    subtext: 'Trendyol & Bayi',
                    left: 'center',
                    textStyle: {
                        fontSize: 17,
                        fontWeight: 500
                ...
                legend: {
                    ...
                    top: 'center',
                    left: 0,
                    data: ['FESTİVAL', 'RUGVİVA', 'FTH', 'LIVENSI', 'KELEBEK'],
                    itemHeight: 8,
                    itemWidth: 8
                },
                ...
                series: [{
                    ...
                    data: [
                        {value: 335, name: 'FESTİVAL'},
                        {value: 310, name: 'RUGVİVA'},
                        {value: 234, name: 'FTH'},
                        {value: 135, name: 'LIVENSI'},
                        {value: 1548, name: 'KELEBEK'}
                    ]
                }]
            });
        }
